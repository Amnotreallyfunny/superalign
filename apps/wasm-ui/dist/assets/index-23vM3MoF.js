(async ()=>{
    ...
    var l = o(((e)=>{
        ...
        function x(e) {
            if (h = !1, b(e), !m) if (n(c) !== null) m = !0, ee || (ee = !0, ne());
            else {
                var t = n(l);
        ...
        e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(e) {
            ...
            return s = a + s, r = {
                ...
                expirationTime: s,
                sortIndex: -1
            }, a > o ? (r.sortIndex = a, t(l, r), n(c) === null && r === n(l) && (h ? (v(S), S = -1) : h = !0, ae(x, a - o))) : (r.sortIndex = s, t(c, r), m || p || (m = !0, ee || (ee = !0, ne()))), r;
        ...
        var h = Object.assign, g = Symbol.for(`react.element`), _ = Symbol.for(`react.transitional.element`), v = Symbol.for(`react.portal`), y = Symbol.for(`react.fragment`), b = Symbol.for(`react.strict_mode`), x = Symbol.for(`react.profiler`), ee = Symbol.for(`react.consumer`), S = Symbol.for(`react.context`), C = Symbol.for(`react.forward_ref`), te = Symbol.for(`react.suspense`), w = Symbol.for(`react.suspense_list`), T = Symbol.for(`react.memo`), ne = Symbol.for(`react.lazy`), re = Symbol.for(`react.activity`), ie = Symbol.for(`react.memo_cache_sentinel`), ae = Symbol.iterator;
        function oe(e) {
...
` + e.stack;
        ...
        var pt = Math.random().toString(36).slice(2), j = `__reactFiber$` + pt, mt = `__reactProps$` + pt, ht = `__reactContainer$` + pt, gt = `__reactEvents$` + pt, _t = `__reactListeners$` + pt, vt = `__reactHandles$` + pt, yt = `__reactResources$` + pt, bt = `__reactMarker$` + pt;
        function xt(e) {
        ...
        var tr = gn && `TextEvent` in window && !er, nr = gn && (!$n || er && 8 < er && 11 >= er), M = ` `, rr = !1;
        function ir(e, t) {
            switch(e){
                case `keyup`:
        ...
        function sr(e, t) {
            switch(e){
                case `compositionend`:
                    return ar(t);
                case `keypress`:
                    return t.which === 32 ? (rr = !0, M) : null;
                case `textInput`:
                    return e = t.data, e === M && rr ? null : e;
                default:
                    return null;
            }
        }
        function cr(e, t) {
            if (or) return e === `compositionend` || !$n && ir(e, t) ? (e = Sn(), xn = bn = yn = null, or = !1, e) : null;
            switch(e){
                case `paste`:
                    return null;
                case `keypress`:
        ...
        function dr(e, t, n, r) {
            un ? dn ? dn.push(r) : dn = [
                r
            ] : un = r, t = Ed(t, `onChange`), 0 < t.length && (n = new On(`onChange`, `change`, null, n, r), e.push({
                event: n,
                listeners: t
            }));
        }
        ...
        function Br(e, t, n) {
            ...
            }), Rr && kr(Rr, r) || (Rr = r, r = Ed(Lr, `onSelect`), 0 < r.length && (t = new On(`onSelect`, `select`, null, t, n), e.push({
                event: t,
                listeners: r
            }), t.target = Ir)));
        }
        ...
        var Kr = Gr(`animationend`), N = Gr(`animationiteration`), qr = Gr(`animationstart`), Jr = Gr(`transitionrun`), Yr = Gr(`transitionstart`), Xr = Gr(`transitioncancel`), Zr = Gr(`transitionend`), Qr = new Map, $r = `abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel`.split(` `);
        $r.push(`scrollEnd`);
        function ei(e, t) {
            Qr.set(e, t), kt(t, [
                e
        ...
        function ii(e, t, n, r) {
            P[ni++] = e, P[ni++] = t, P[ni++] = n, P[ni++] = r, ri |= r, e.lanes |= r, e = e.alternate, e !== null && (e.lanes |= r);
        }
        function ai(e, t, n, r) {
        ...
        function hi(e, t, n, r, a, o) {
            ...
            if (r = e, typeof e == `function`) fi(e) && (s = 1);
                ...
                case te:
                    return e = di(13, n, t, a), e.elementType = te, e.lanes = o, e;
                case w:
                    return e = di(19, n, t, a), e.elementType = w, e.lanes = o, e;
                default:
        ...
        function Mi(e, t, n) {
            ...
            if (30 < a) {
                var o = i - i % 5;
                a = (r & (1 << o) - 1).toString(32), r >>= o, i -= o, ki = 1 << 32 - Ke(t) + i | n << i | r, Ai = a + e;
            ...
            for(var a = t, o = !1; a !== null;){
                ...
                if (a.tag === 10) {
                    ...
                    if (s = s.memoizedProps, s !== null) {
                        var c = a.type;
                        Or(a.pendingProps.value, s.value) || (e === null ? e = [
                            c
                        ] : e.push(c));
                    }
                } else if (a === ve.current) {
                    if (s = a.alternate, s === null) throw Error(i(387));
                    s.memoizedState.memoizedState !== a.memoizedState.memoizedState && (e === null ? e = [
                        Qf
                    ] : e.push(Qf));
                }
                a = a.return;
        ...
        var ya = E.S;
        E.S = function(e, t) {
            eu = k(), typeof t == `object` && t && typeof t.then == `function` && ga(e, t), ya !== null && ya(e, t);
        };
        var ba = pe(null);
        function xa() {
            var e = ba.current;
        ...
        var wa = Error(i(460)), Ta = Error(i(474)), Ea = Error(i(542)), Da = {
            then: function() {}
        };
        function Oa(e) {
        ...
        function za(e) {
            ...
            function l(e, t, n, r) {
                var i = n.type;
                return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === ne && Aa(i) === t.type) ? (t = a(t, n.props), La(t, n), t.return = e, t) : (t = hi(n.type, n.key, n.props, null, e.mode, r), La(t, n), t.return = e, t);
            }
            function u(e, t, n, r) {
            ...
            function f(e, t, n) {
                ...
                if (typeof t == `object` && t) {
                    switch(t.$$typeof){
                        case _:
                            return n = hi(t.type, t.key, t.props, null, e.mode, n), La(n, t), n.return = e, n;
                        case v:
            ...
            if (a !== null) {
                ...
                do {
                    ...
                    if (p ? (J & f) === f : (r & f) === f) {
                        ...
                        f = s.callback, f !== null && (e.flags |= 64, p && (e.flags |= 8192), p = i.callbacks, p === null ? i.callbacks = [
                            f
                        ] : p.push(f));
                    } else p = {
                        lane: f,
        ...
        function Ro(e, t, n) {
            ...
            if (o = e.baseState, a === null) e.memoizedState = o;
                ...
                if (l === null ? s = o : l.next = c, !Or(o, e.memoizedState) && (ic = !0, d && (n = ha, n !== null))) throw n;
        ...
        function Bo(e, t, n) {
            ...
            if (s && (a.memoizedState = n, ic = !0), a = a.queue, ds(Uo.bind(null, r, a, e), [
                e
        ...
        function Vo(e, t, n) {
            e.flags |= 16384, e = {
                getSnapshot: t,
                value: n
            }, t = z.updateQueue, t === null ? (t = Mo(), z.updateQueue = t, t.stores = [
                e
        ...
        function rs(e, t, n) {
            ...
            return n !== t.memoizedState && (z.flags |= 2048, os(9, {
                destroy: void 0
        ...
        function cs(e, t, n, r) {
            var i = jo();
            z.flags |= e, i.memoizedState = os(1 | t, {
                destroy: void 0
            }, n, r === void 0 ? null : r);
        }
        function ls(e, t, n, r) {
        ...
        function fs(e) {
            z.flags |= 4;
            var t = z.updateQueue;
            if (t === null) t = Mo(), z.updateQueue = t, t.events = [
                e
            ];
            else {
                var n = t.events;
        ...
        function ys(e, t) {
            ...
            return t !== null && Co(t, r[1]) ? r[0] : (n.memoizedState = [
                e,
                t
            ], e);
        }
        ...
        function Ss(e, t, n, r) {
            return Or(n, t) ? n : eo.current === null ? !(mo & 42) || mo & 1073741824 && !(J & 261930) ? (ic = !0, e.memoizedState = n) : (e = mu(), z.lanes |= e, Gl |= e, t) : (e = xs(e, n, r), Or(e, t) || (ic = !0), e);
        }
        ...
        function Ps(e, t, n, r) {
            ...
            if (Is(e)) Ls(t, i);
                ...
                if (e.lanes === 0 && (a === null || a.lanes === 0) && (a = t.lastRenderedReducer, a !== null)) try {
                    ...
                    if (i.hasEagerState = !0, i.eagerState = s, Or(s, o)) return ii(e, t, i, 0), K === null && F(), !1;
                } catch  {}
        ...
        var Bs = {
            ...
            useReducer: function(e, t, n) {
                ...
                return r.memoizedState = r.baseState = i, e = {
                    ...
                    lastRenderedState: i
                }, r.queue = e, e = e.dispatch = Ms.bind(null, z, e), [
                    r.memoizedState,
                    e
                ];
            },
            ...
            useTransition: function() {
                var e = Ko(!1);
                return e = Cs.bind(null, z, e.queue, !0, !1), jo().memoizedState = e, [
                    !1,
                    e
                ];
            },
            useSyncExternalStore: function(e, t, n) {
                ...
                return a.queue = o, us(Uo.bind(null, r, o, e), [
                    e
                ]), r.flags |= 2048, os(9, {
                    destroy: void 0
            ...
            useOptimistic: function(e) {
                ...
                return t.queue = n, t = Fs.bind(null, z, !0, n), n.dispatch = t, [
                    e,
                    t
                ];
            },
        ...
        function $s(e, t, n) {
            return n = Ga(n), n.tag = 3, n.payload = {
                element: null
            }, n.callback = function() {
                Zs(e, t);
            }, n;
        ...
        function tc(e, t, n, r) {
            ...
            o !== null && typeof o.componentDidCatch == `function` && (e.callback = function() {
                Qs(t, n, r), typeof i != `function` && (ru === null ? ru = new Set([
                    this
                ]) : ru.add(this));
                var e = r.stack;
        ...
        function nc(e, t, n, r, a) {
            if (n.flags |= 32768, typeof r == `object` && r && typeof r.then == `function`) {
                if (t = n.alternate, t !== null && ea(t, n, a, !0), n = ao.current, n !== null) {
                    switch(n.tag){
                        case 31:
                        case 13:
                            return oo === null ? Du() : n.alternate === null && X === 0 && (X = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Da ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = new Set([
                                r
                            ]) : t.add(r), Gu(e, r, a)), !1;
                        case 22:
                            return n.flags |= 65536, r === Da ? n.flags |= 16384 : (t = n.updateQueue, t === null ? (t = {
                                transitions: null,
            ...
            if (L) return t = ao.current, t === null ? (r !== zi && (t = Error(i(423), {
                cause: r
            }), Ki(xi(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = xi(r, n), a = $s(e.stateNode, r, a), Ja(e, a), X !== 4 && (X = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== zi && (e = Error(i(422), {
                cause: r
            }), Ki(xi(e, n)))), !1;
            var o = Error(i(520), {
                cause: r
            });
            if (o = xi(o, n), Xl === null ? Xl = [
                o
            ] : Xl.push(o), X !== 4 && (X = 2), t === null) return !0;
            r = xi(r, n), n = t;
            do {
                switch(n.tag){
                    case 3:
                        return n.flags |= 65536, e = a & -a, n.lanes |= e, e = $s(n.stateNode, r, e), Ja(n, e), !1;
                    case 1:
                        if (t = n.type, o = n.stateNode, !(n.flags & 128) && (typeof t.getDerivedStateFromError == `function` || o !== null && typeof o.componentDidCatch == `function` && (ru === null || !ru.has(o)))) return n.flags |= 65536, a &= -a, n.lanes |= a, a = ec(a), tc(a, e, n, r), Ja(n, a), !1;
                }
                n = n.return;
            }while (n !== null);
            return !1;
        ...
        function Cc(e, t, n) {
            ...
            return a ? (uo(t), c = r.fallback, a = t.mode, l = e.child, u = l.sibling, r = pi(l, {
                ...
                mode: `visible`,
                children: r.children
            }), n.return = t, n.sibling = null, e !== null && (s = t.deletions, s === null ? (t.deletions = [
                e
            ], t.flags |= 16) : s.push(e)), t.child = n, t.memoizedState = null, n);
        }
        function wc(e, t) {
            return t = Tc({
                mode: `visible`,
            ...
            switch(t.lanes = 0, t.tag){
                ...
                case 3:
                    a: {
                        ...
                        if (r = s.cache, Xi(t, la, r), r !== o.cache && $i(t, [
                            la
                        ], n, !0), Xa(), r = s.element, o.isDehydrated) if (o = {
                            element: r,
                            isDehydrated: !1,
                            cache: s.cache
                    ...
                    return t;
                case 26:
                    return hc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : L || (n = t.type, e = t.pendingProps, r = Bd(_e.current).createElement(n), r[j] = t, r[mt] = e, Pd(r, n, e), Et(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
                case 27:
                    return xe(t), e === null && L && (r = t.stateNode = ff(t.type, t.pendingProps, _e.current), Ii = t, Ri = !0, a = I, Zd(t.type) ? (lf = a, I = cf(r.firstChild)) : I = a), ac(e, t, t.pendingProps.children, n), hc(e, t), e === null && (t.flags |= 4194304), t.child;
                case 5:
                ...
                case 13:
                    return Cc(e, t, n);
                case 4:
                    return ye(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = Ba(t, null, r, n) : ac(e, t, r, n), t.child;
                case 11:
                ...
                case 9:
                    return a = t.type._context, r = t.pendingProps.children, na(t), a = ra(a), r = r(a), t.flags |= 1, ac(e, t, r, n), t.child;
                case 14:
                ...
                case 24:
                    return na(t), r = ra(la), e === null ? (a = xa(), a === null && (a = K, o = ua(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
                        parent: r,
                        cache: a
                    }, Ua(t), Xi(t, la, a)) : ((e.lanes & n) !== 0 && (Wa(e, t), Za(t, null, null, n), Xa()), a = e.memoizedState, o = t.memoizedState, a.parent === r ? (r = o.cache, Xi(t, la, r), r !== a.cache && $i(t, [
                        la
                    ], n, !0)) : (a = {
                        parent: r,
                        cache: r
        ...
        function zc(e, t, n) {
            ...
            switch(Pi(t), t.tag){
                ...
                case 1:
                    return U(t), null;
                case 3:
                    return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), Zi(la), be(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (Ui(t) ? Pc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, Gi())), U(t), null;
                case 26:
                ...
                case 27:
                    if (Se(t), n = _e.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Pc(t);
                        ...
                        e = he.current, Ui(t) ? Vi(t, e) : (e = ff(a, r, n), t.stateNode = e, Pc(t));
                    }
                    return U(t), null;
                case 5:
                ...
                case 6:
                    if (e && t.stateNode != null) e.memoizedProps !== r && Pc(t);
                        ...
                        if (e = _e.current, Ui(t)) {
                            ...
                            e[j] = t, e = !!(e.nodeValue === n || r !== null && !0 === r.suppressHydrationWarning || Md(e.nodeValue, n)), e || Bi(t, !0);
                ...
                case 19:
                    ...
                    return r.tail === null ? (U(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = k(), e.sibling = null, n = R.current, O(R, a ? n & 1 | 2 : n & 1), L && ji(t, r.treeForkCount), e);
                case 22:
                case 23:
                    return fo(t), io(), r = t.memoizedState !== null, e === null ? r && (t.flags |= 8192) : e.memoizedState !== null !== r && (t.flags |= 8192), r ? n & 536870912 && !(t.flags & 128) && (U(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : U(t), n = t.updateQueue, n !== null && Lc(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== n && (t.flags |= 2048), e !== null && me(ba), null;
                case 24:
                    return n = null, e !== null && (n = e.memoizedState.cache), t.memoizedState.cache !== n && (t.flags |= 2048), Zi(la), U(t), null;
                case 25:
                    return null;
                case 30:
                    return null;
        ...
        function Bc(e, t) {
            switch(Pi(t), t.tag){
                ...
                case 3:
                    return Zi(la), be(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
                case 26:
                case 27:
                case 5:
                    return Se(t), null;
                ...
                case 22:
                case 23:
                    return fo(t), io(), e !== null && me(ba), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
                case 24:
                    return Zi(la), null;
                case 25:
                    return null;
                    ...
                    if (gl(t, e), yl(e), r & 512 && (nl || n === null || qc(n, n.return)), r & 4) {
                        ...
                        if (r = e.memoizedState, n === null) if (r === null) if (e.stateNode === null) {
                            a: {
                                ...
                                b: switch(r){
                                    case `title`:
                                        o = a.getElementsByTagName(`title`)[0], (!o || o[bt] || o[j] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r), a.head.insertBefore(o, a.querySelector(`head > title`))), Pd(o, r, n), o[j] = e, Et(o), r = o;
                                        break a;
                                    case `link`:
        ...
        }, zl = typeof WeakMap == `function` ? WeakMap : Map, G = 0, K = null, q = null, J = 0, Y = 0, Bl = null, Vl = !1, Hl = !1, Ul = !1, Wl = 0, X = 0, Gl = 0, Kl = 0, ql = 0, Jl = 0, Yl = 0, Xl = null, Zl = null, Ql = !1, $l = 0, eu = 0, tu = 1 / 0, nu = null, ru = null, iu = 0, au = null, ou = null, su = 0, cu = 0, lu = null, uu = null, du = 0, fu = null;
        function pu() {
        ...
        function Ou(e, t, n) {
            ...
            while (1);
            return t && e.shellSuspendCounter++, Yi = Ji = null, G = r, E.H = i, E.A = a, q === null && (K = null, J = 0, F()), o;
        }
        function ku() {
            for(; q !== null;)Mu(q);
        }
        function Au(e, t) {
            ...
            G |= 2;
            var r = Tu(), a = Eu();
            K !== e || J !== t ? (nu = null, tu = k() + 500, Su(e, t)) : Hl = et(e, t);
            a: do try {
                if (Y !== 0 && q !== null) {
                    t = q;
                    var o = Bl;
            ...
            while (1);
            return Yi = Ji = null, E.H = r, E.A = a, G = n, q === null ? (K = null, J = 0, F(), X) : 0;
        }
        function ju() {
            for(; q !== null && !Ne();)Mu(q);
        }
        ...
        function Lu(e, t, n, r, a, o, s, c, l) {
            ...
            if (t !== null) {
                ...
                if (o = t.lanes | t.childLanes, o |= ri, at(e, n, o, s, c, l), e === K && (q = K = null, J = 0), ou = t, au = e, su = n, cu = o, lu = a, uu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(Re, function() {
                    return Uu(), null;
        ...
        function cd(e, t) {
            ...
            var r = J;
            return r = $e(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (gu(e, r, t), sd(e, k()), e.callbackNode != null && e.callbackNode === n ? cd.bind(null, e) : null);
        }
        function ld(e, t) {
            if (Hu()) return null;
            gu(e, t, !0);
        ...
        ei(Kr, `onAnimationEnd`), ei(N, `onAnimationIteration`), ei(qr, `onAnimationStart`), ei(`dblclick`, `onDoubleClick`), ei(`focusin`, `onFocus`), ei(`focusout`, `onBlur`), ei(Jr, `onTransitionRun`), ei(Yr, `onTransitionStart`), ei(Xr, `onTransitionCancel`), ei(Zr, `onTransitionEnd`), At(`onMouseEnter`, [
            `mouseout`,
            `mouseover`
        ]), At(`onMouseLeave`, [
            `mouseout`,
            ...
            `pointerout`,
            `pointerover`
        ]), kt(`onChange`, `change click focusin focusout input keydown keyup selectionchange`.split(` `)), kt(`onSelect`, `focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange`.split(` `)), kt(`onBeforeInput`, [
            `compositionend`,
            `keypress`,
            `textInput`,
            `paste`
        ...
        function wd(e, t, n, r, i) {
            ...
            mn(function() {
                ...
                if (!(t & 7)) {
                    ...
                    x && (nr && n.locale !== `ko` && (or || x !== `onCompositionStart` ? x === `onCompositionEnd` && or && (b = Sn()) : (yn = i, bn = `value` in yn ? yn.value : yn.textContent, or = !0)), y = Ed(r, x), 0 < y.length && (x = new Bn(x, e, null, n, i), s.push({
                        event: x,
                        listeners: y
                    }), b ? x.data = b : (b = ar(n), b !== null && (x.data = b)))), (b = tr ? sr(e, n) : cr(e, n)) && (x = Ed(r, `onBeforeInput`), 0 < x.length && (y = new Bn(`onBeforeInput`, `beforeinput`, null, n, i), s.push({
                        event: y,
                        listeners: x
...
`).replace(Ad, ``);
        ...
        function Vf(e, t, n) {
            ...
            for(r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++){
                var a = n[i];
                if (!(a[bt] || a[j] || e === `link` && a.getAttribute(`rel`) === `stylesheet`) && a.namespaceURI !== `http://www.w3.org/2000/svg`) {
        ...
        function np(e, t, n, r, i, a) {
            i = tp(i), r.context === null ? r.context = i : r.pendingContext = i, r = Ga(t), r.payload = {
                element: n
            }, a = a === void 0 ? null : a, a !== null && (r.callback = a), n = Ka(e, r, t), n !== null && (hu(n, e, t), qa(n, e, t));
        }
        function rp(e, t) {
        ...
        n(), t.exports = h();
    })), _ = c(u(), 1), v = g(), y = `modulepreload`, b = function(e) {
        return `/` + e;
    }, x = {}, ee = function(e, t, n) {
        ...
        if (t && t.length > 0) {
            ...
            r = o(t.map((t)=>{
                ...
                if (o.rel = r ? `stylesheet` : y, r || (o.as = `script`), o.crossOrigin = ``, o.href = t, a && o.setAttribute(`nonce`, a), document.head.appendChild(o), r) return new Promise((e, n)=>{
    ...
    function se(e, t, n, r = {}) {
        ...
        function f(e, t) {
            ...
            n && n(r, e), l = u() + 1;
            let d = re(r, l), f = h.createHref(r.mask || r);
            try {
                o.pushState(d, ``, f);
            } catch (e) {
        ...
        function p(e, t) {
            ...
            let r = C(e) ? e : ie(h.location, e, t);
            n && n(r, e), l = u();
            let i = re(r, l), d = h.createHref(r.mask || r);
    ...
    function de(e, t = [], n = [], r = ``, i = !1) {
        let a = (e, a, o = i, s)=>{
            ...
            e.children && e.children.length > 0 && (w(e.index !== !0, `Index routes must not have child routes. Please remove all child routes from route path "${l}".`), de(e.children, t, u, l, o)), !(e.path == null && !e.index) && t.push({
                path: l,
                score: be(l, e.index),
                routesMeta: u
            });
    ...
    var me = /^:[\w-]+$/, O = 3, he = 2, ge = 1, _e = 10, ve = -2, ye = (e)=>e === `*`;
    function be(e, t) {
        let n = e.split(`/`), r = n.length;
        return n.some(ye) && (r += ve), t && (r += he), n.filter((e)=>!ye(e)).reduce((e, t)=>e + (me.test(t) ? O : t === `` ? ge : _e), r);
    }
    function xe(e, t) {
    ...
    function Se(e, t, n = !1) {
        ...
        for(let e = 0; e < r.length; ++e){
            let s = r[e], c = e === r.length - 1, l = a === `/` ? t : t.slice(a.length) || `/`, u = Ce({
                path: s.relativePath,
                caseSensitive: s.caseSensitive,
                end: c
            }, l), d = s.route;
            if (!u && c && n && !r[r.length - 1].route.index && (u = Ce({
                path: s.relativePath,
                caseSensitive: s.caseSensitive,
                end: !1
            }, l)), !u) return null;
    ...
    var De = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;
    function Oe(e, t = `/`) {
        let { pathname: n, search: r = ``, hash: i = `` } = typeof e == `string` ? oe(e) : e, a;
    ...
    function Ne(e, t, n, r = !1) {
        let i;
        typeof e == `string` ? i = oe(e) : (i = {
            ...e
        }, w(!i.pathname || !i.pathname.includes(`?`), Ae(`?`, `pathname`, `search`, i)), w(!i.pathname || !i.pathname.includes(`#`), Ae(`#`, `pathname`, `hash`, i)), w(!i.search || !i.search.includes(`#`), Ae(`#`, `search`, `hash`, i)));
    ...
    var Pe = (e)=>e.replace(/\/\/+/g, `/`), k = (e)=>Pe(e.join(`/`)), Fe = (e)=>e.replace(/\/+$/, ``), Ie = (e)=>Fe(e).replace(/^\/*/, `/`), Le = (e)=>!e || e === `?` ? `` : e.startsWith(`?`) ? e : `?` + e, Re = (e)=>!e || e === `#` ? `` : e.startsWith(`#`) ? e : `#` + e, ze = class {
    ...
    var He = typeof window < `u` && window.document !== void 0 && window.document.createElement !== void 0;
    function Ue(e, t) {
        let n = e;
        if (typeof n != `string` || !De.test(n)) return {
            absoluteURL: void 0,
            isExternal: !1,
            to: n
        };
        let r = n, i = !1;
        if (He) try {
            let e = new URL(window.location.href), r = n.startsWith(`//`) ? new URL(e.protocol + n) : new URL(n), a = Ee(r.pathname, t);
    ...
    var nt = `REACT_ROUTER_ERROR`, rt = `REDIRECT`, it = `ROUTE_ERROR_RESPONSE`;
    function at(e) {
        if (e.startsWith(`${nt}:${rt}:{`)) try {
    ...
    function ot(e) {
        if (e.startsWith(`${nt}:${it}:{`)) try {
            let t = JSON.parse(e.slice(40));
            if (typeof t == `object` && t && typeof t.status == `number` && typeof t.statusText == `string`) return new ze(t.status, t.statusText, t.data);
        } catch  {}
    }
    function st(e, { relative: t } = {}) {
        w(ct(), `useHref() may be used only in the context of a <Router> component.`);
        let { basename: n, navigator: r } = _.useContext(A), { hash: i, pathname: a, search: o } = j(e, {
            relative: t
        }), s = a;
        return n !== `/` && (s = a === `/` ? n : k([
            n,
    ...
    function lt() {
        return w(ct(), `useLocation() may be used only in the context of a <Router> component.`), _.useContext($e).location;
    }
    ...
    function pt() {
        w(ct(), `useNavigate() may be used only in the context of a <Router> component.`);
        let e = _.useContext(Ke), { basename: t, navigator: n } = _.useContext(A), { matches: r } = _.useContext(et), { pathname: i } = lt(), a = JSON.stringify(Me(r)), o = _.useRef(!1);
        return dt(()=>{
            o.current = !0;
        }), _.useCallback((r, s = {})=>{
            ...
            e == null && t !== `/` && (c.pathname = c.pathname === `/` ? t : k([
                t,
                c.pathname
    ...
    function j(e, { relative: t } = {}) {
        let { matches: n } = _.useContext(et), { pathname: r } = lt(), i = JSON.stringify(Me(n));
        return _.useMemo(()=>Ne(e, JSON.parse(i), r, t === `path`), [
            e,
            i,
            r,
            t
    ...
    function ht(e, t, n) {
        w(ct(), `useRoutes() may be used only in the context of a <Router> component.`);
        let { navigator: r } = _.useContext(A), { matches: i } = _.useContext(et), a = i[i.length - 1], o = a ? a.params : {}, s = a ? a.pathname : `/`, c = a ? a.pathnameBase : `/`, l = a && a.route;
        {
            let e = l && l.path || ``;
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`);
    ...
    function gt() {
        let e = jt(), t = Be(e) ? `${e.status} ${e.statusText}` : e instanceof Error ? e.message : JSON.stringify(e), n = e instanceof Error ? e.stack : null, r = `rgba(200,200,200, 0.5)`, i = {
            padding: `0.5rem`,
            backgroundColor: r
        }, a = {
            padding: `2px 4px`,
        ...
        return console.error(`Error handled by React Router default ErrorBoundary:`, e), o = _.createElement(_.Fragment, null, _.createElement(`p`, null, `💿 Hey developer 👋`), _.createElement(`p`, null, `You can provide a way better UX than this when your app throws errors by providing your own `, _.createElement(`code`, {
            style: a
        }, `ErrorBoundary`), ` or`, ` `, _.createElement(`code`, {
            style: a
        }, `errorElement`), ` prop on your route.`)), _.createElement(_.Fragment, null, _.createElement(`h2`, null, `Unexpected Application Error!`), _.createElement(`h3`, {
            style: {
                fontStyle: `italic`
            }
    ...
    var _t = _.createElement(gt, null), vt = class extends _.Component {
        constructor(e){
            super(e), this.state = {
                location: e.location,
        ...
        render() {
            ...
            let t = e === void 0 ? this.props.children : _.createElement(et.Provider, {
                value: this.props.routeContext
            }, _.createElement(tt.Provider, {
                value: e,
                children: this.props.component
            }));
            return this.context ? _.createElement(bt, {
                error: e
            }, t) : t;
        }
    };
    ...
    function bt({ children: e, error: t }) {
        ...
        if (typeof t == `object` && t && `digest` in t && typeof t.digest == `string`) {
            ...
            if (e) {
                ...
                if (He && !yt.get(t)) if (i.isExternal || e.reloadDocument) window.location.href = i.absoluteURL || i.to;
                else {
    ...
    function xt({ routeContext: e, match: t, children: n }) {
        ...
        return r && r.static && r.staticContext && (t.route.errorElement || t.route.ErrorBoundary) && (r.staticContext._deepestRenderedBoundaryId = t.route.id), _.createElement(et.Provider, {
            value: e
        }, n);
    }
    function St(e, t = [], n) {
        ...
        if (n && r) {
            ...
            for(let e = 0; e < i.length; e++){
                ...
                if ((t.route.HydrateFallback || t.route.hydrateFallbackElement) && (s = e), t.route.id) {
                    ...
                    if (t.route.lazy || c) {
                        n.isStatic && (o = !0), i = s >= 0 ? i.slice(0, s + 1) : [
                            i[0]
                        ];
                        break;
                    }
        ...
        return i.reduceRight((e, n, c)=>{
            ...
            r && (u = a && n.route.id ? a[n.route.id] : void 0, f = n.route.errorElement || _t, o && (s < 0 && c === 0 ? (Pt(`route-fallback`, !1, "No `HydrateFallback` element provided to render during initial hydration"), d = !0, p = null) : s === c && (d = !0, p = n.route.hydrateFallbackElement || null)));
            let m = t.concat(i.slice(0, c + 1)), h = ()=>{
                let t;
                return t = u ? f : d ? p : n.route.Component ? _.createElement(n.route.Component, null) : n.route.element ? n.route.element : e, _.createElement(xt, {
                    match: n,
                    routeContext: {
                        outlet: e,
                        matches: m,
            ...
            return r && (n.route.ErrorBoundary || n.route.errorElement || c === 0) ? _.createElement(vt, {
                location: r.location,
    ...
    function At() {
        ...
        return _.useMemo(()=>e.map((e)=>D(e, t)), [
            e,
            t
        ]);
    }
    function jt() {
        let e = _.useContext(tt), t = Tt(`useRouteError`), n = Dt(`useRouteError`);
        return e === void 0 ? t.errors?.[n] : e;
    }
    function Mt() {
        let { router: e } = wt(`useNavigate`), t = Dt(`useNavigate`), n = _.useRef(!1);
        return dt(()=>{
            n.current = !0;
        }), _.useCallback(async (r, i = {})=>{
            T(n.current, ut), n.current && (typeof r == `number` ? await e.navigate(r) : await e.navigate(r, {
                fromRouteId: t,
                ...i
            }));
        }, [
    ...
    _.memo(Ft);
    function Ft({ routes: e, manifest: t, future: n, state: r, isStatic: i, onError: a }) {
        return ht(e, void 0, {
            manifest: t,
            state: r,
            isStatic: i,
    ...
    function It({ to: e, replace: t, state: n, relative: r }) {
        w(ct(), `<Navigate> may be used only in the context of a <Router> component.`);
        let { static: i } = _.useContext(A);
        ...
        let { matches: a } = _.useContext(et), { pathname: o } = lt(), s = ft(), c = Ne(e, Me(a), o, r === `path`), l = JSON.stringify(c);
        return _.useEffect(()=>{
            s(JSON.parse(l), {
                replace: t,
                state: n,
    ...
    function Rt({ basename: e = `/`, children: t = null, location: n, navigationType: r = `POP`, navigator: i, static: a = !1, useTransitions: o }) {
        w(!ct(), `You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);
        ...
        return T(h != null, `<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`), h == null ? null : _.createElement(A.Provider, {
            value: c
        }, _.createElement($e.Provider, {
            children: t,
            value: h
        }));
    }
    ...
    function Bt(e, t = []) {
        ...
        return _.Children.forEach(e, (e, r)=>{
            ...
            w(e.type === Lt, `[${typeof e.type == `string` ? e.type : e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`), w(!e.props.index || !e.props.children, `An index route cannot have child routes.`);
            let a = {
    ...
    var Vt = `get`, Ht = `application/x-www-form-urlencoded`;
    function Ut(e) {
    ...
    function Qt(e) {
        return e != null && !Zt.has(e) ? (T(!1, `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ht}"`), null) : e;
    }
    function $t(e, t) {
        let n, r, i, a, o;
        if (Gt(e)) {
            let o = e.getAttribute(`action`);
            r = o ? Ee(o, t) : null, n = e.getAttribute(`method`) || Vt, i = Qt(e.getAttribute(`enctype`)) || Ht, a = new FormData(e);
            ...
            if (r = s ? Ee(s, t) : null, n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || Vt, i = Qt(e.getAttribute(`formenctype`)) || Qt(o.getAttribute(`enctype`)) || Ht, a = new FormData(o, e), !Xt()) {
    ...
    function an(e, t, n, r) {
        ...
        return n ? i.pathname.endsWith(`/`) ? i.pathname = `${i.pathname}_.${r}` : i.pathname = `${i.pathname}.${r}` : i.pathname === `/` ? i.pathname = `_root.${r}` : t && Ee(i.pathname, t) === `/` ? i.pathname = `${Fe(t)}/_root.${r}` : i.pathname = `${Fe(i.pathname)}.${r}`, i;
    }
    async function on(e, t) {
        if (e.id in t) return t[e.id];
        try {
            let n = await ee(()=>import(e.module).then(async (m)=>{
                    await m.__tla;
                    return m;
                }), []);
            return t[e.id] = n, n;
    ...
    function yn(e, t) {
        let n = _.useContext(_n), [r, i] = _.useState(!1), [a, o] = _.useState(!1), { onFocus: s, onBlur: c, onMouseEnter: l, onMouseLeave: u, onTouchStart: d } = t, f = _.useRef(null);
        _.useEffect(()=>{
    ...
    function xn({ page: e, ...t }) {
        let n = Ye(), { router: r } = hn(), i = _.useMemo(()=>le(r.routes, e, r.basename), [
            r.routes,
            e,
            r.basename
        ]);
        return i ? n ? _.createElement(Cn, {
            page: e,
            matches: i,
            ...t
        }) : _.createElement(wn, {
    ...
    function Sn(e) {
        let { manifest: t, routeModules: n } = vn(), [r, i] = _.useState([]);
        return _.useEffect(()=>{
            let r = !1;
    ...
    function Cn({ page: e, matches: t, ...n }) {
        let r = lt(), { future: i } = vn(), { basename: a } = hn(), o = _.useMemo(()=>{
            if (e === r.pathname + r.search + r.hash) return [];
            let n = an(e, a, i.unstable_trailingSlashAwareDataRequests, `rsc`), o = !1, s = [];
        ...
        return _.createElement(_.Fragment, null, o.map((e)=>_.createElement(`link`, {
                key: e,
                rel: `prefetch`,
                as: `fetch`,
                href: e,
    ...
    function wn({ page: e, matches: t, ...n }) {
        let r = lt(), { future: i, manifest: a, routeModules: o } = vn(), { basename: s } = hn(), { loaderData: c, matches: l } = gn(), u = _.useMemo(()=>un(e, t, l, a, r, `data`), [
            e,
            t,
            l,
            a,
            r
        ]), d = _.useMemo(()=>un(e, t, l, a, r, `assets`), [
            e,
            t,
            l,
            a,
    ...
    try {
        En && (window.__reactRouterVersion = `7.15.1`);
    } catch  {}
    function Dn({ basename: e, children: t, useTransitions: n, window: r }) {
        ...
        return _.useLayoutEffect(()=>a.listen(c), [
            a,
            c
        ]), _.createElement(Rt, {
            basename: e,
    ...
    function On({ basename: e, children: t, history: n, useTransitions: r }) {
        let [i, a] = _.useState({
            action: n.action,
            location: n.location
        }), o = _.useCallback((e)=>{
        ...
        return _.useLayoutEffect(()=>n.listen(o), [
            n,
            o
        ]), _.createElement(Rt, {
            basename: e,
    ...
    var kn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, An = _.forwardRef(function({ onClick: e, discover: t = `render`, prefetch: n = `none`, relative: r, reloadDocument: i, replace: a, mask: o, state: s, target: c, to: l, preventScrollReset: u, viewTransition: d, defaultShouldRevalidate: f, ...p }, m) {
        let { basename: h, navigator: g, useTransitions: v } = _.useContext(A), y = typeof l == `string` && kn.test(l), b = Ue(l, h);
        l = b.to;
        let x = st(l, {
            relative: r
        }), ee = lt(), S = null;
        if (o) {
            ...
            h !== `/` && (e.pathname = e.pathname === `/` ? h : k([
                h,
                e.pathname
            ])), S = g.createHref(e);
        }
        let [C, te, w] = yn(n, p), T = Ln(l, {
            replace: a,
            mask: o,
            state: s,
            target: c,
        ...
        let re = !(b.isExternal || i), ie = _.createElement(`a`, {
            ...p,
            ...w,
        ...
        return C && !y ? _.createElement(_.Fragment, null, ie, _.createElement(xn, {
            page: x
        })) : ie;
    });
    An.displayName = `Link`;
    var jn = _.forwardRef(function({ "aria-current": e = `page`, caseSensitive: t = !1, className: n = ``, end: r = !1, style: i, to: a, viewTransition: o, children: s, ...c }, l) {
        let u = j(a, {
            relative: c.relative
        }), d = lt(), f = _.useContext(qe), { navigator: p, basename: m } = _.useContext(A), h = f != null && qn(u) && o === !0, g = p.encodeLocation ? p.encodeLocation(u).pathname : u.pathname, v = d.pathname, y = f && f.navigation && f.navigation.location ? f.navigation.location.pathname : null;
        t || (v = v.toLowerCase(), y = y ? y.toLowerCase() : null, g = g.toLowerCase()), y && m && (y = Ee(y, m) || y);
        let b = g !== `/` && g.endsWith(`/`) ? g.length - 1 : g.length, x = v === g || !r && v.startsWith(g) && v.charAt(b) === `/`, ee = y != null && (y === g || !r && y.startsWith(g) && y.charAt(g.length) === `/`), S = {
            isActive: x,
            isPending: ee,
            isTransitioning: h
        }, C = x ? e : void 0, te;
        te = typeof n == `function` ? n(S) : [
            n,
            x ? `active` : null,
            ee ? `pending` : null,
    ...
    var Mn = _.forwardRef(({ discover: e = `render`, fetcherKey: t, navigate: n, reloadDocument: r, replace: i, state: a, method: o = Vt, action: s, onSubmit: c, relative: l, preventScrollReset: u, viewTransition: d, defaultShouldRevalidate: f, ...p }, m)=>{
        let { useTransitions: h } = _.useContext(A), g = Bn(), v = Vn(s, {
            relative: l
        }), y = o.toLowerCase() === `get` ? `get` : `post`, b = typeof s == `string` && kn.test(s);
    ...
    function Nn({ getKey: e, storageKey: t, ...n }) {
        let r = _.useContext(_n), { basename: i } = _.useContext(A), a = lt(), o = At();
        Gn({
            getKey: e,
            storageKey: t
        });
    ...
    function Ln(e, { target: t, replace: n, mask: r, state: i, preventScrollReset: a, relative: o, viewTransition: s, defaultShouldRevalidate: c, useTransitions: l } = {}) {
        let u = ft(), d = lt(), f = j(e, {
            relative: o
        });
        return _.useCallback((p)=>{
            if (Jt(p, t)) {
                p.preventDefault();
                let t = n === void 0 ? ae(d) === ae(f) : n, m = ()=>u(e, {
                        replace: t,
                        mask: r,
                        state: i,
    ...
    var Rn = 0, zn = ()=>`__${String(++Rn)}__`;
    function Bn() {
        let { router: e } = Fn(`useSubmit`), { basename: t } = _.useContext(A), n = Ot(), r = e.fetch, i = e.navigate;
        return _.useCallback(async (e, a = {})=>{
            let { action: o, method: s, encType: c, formData: l, body: u } = $t(e, t);
            a.navigate === !1 ? await r(a.fetcherKey || zn(), n, a.action || o, {
    ...
    function Vn(e, { relative: t } = {}) {
        let { basename: n } = _.useContext(A), r = _.useContext(et);
        ...
        return (!e || e === `.`) && i.route.index && (a.search = a.search ? a.search.replace(/^\?/, `?index&`) : `?index`), n !== `/` && (a.pathname = a.pathname === `/` ? n : k([
            n,
            a.pathname
        ])), ae(a);
    }
    var Hn = `react-router-scroll-positions`, Un = {};
    function Wn(e, t, n, r) {
        let i = null;
        return r && (i = r(n === `/` ? e : {
            ...e,
            pathname: Ee(e.pathname, n) || e.pathname
        }, t)), i ??= e.key, i;
    }
    function Gn({ getKey: e, storageKey: t } = {}) {
        let { router: n } = Fn(`useScrollRestoration`), { restoreScrollPosition: r, preventScrollReset: i } = In(`useScrollRestoration`), { basename: a } = _.useContext(A), o = lt(), s = At(), c = kt();
        _.useEffect(()=>(window.history.scrollRestoration = `manual`, ()=>{
            ...
            let t = n?.enableScrollRestoration(Un, ()=>window.scrollY, e ? (t, n)=>Wn(t, n, a, e) : void 0);
            return ()=>t && t();
        }, [
            n,
            a,
    ...
    function qn(e, { relative: t } = {}) {
        ...
        let { basename: r } = Fn(`useViewTransitionState`), i = j(e, {
            relative: t
        });
        if (!n.isTransitioning) return !1;
        let a = Ee(n.currentLocation.pathname, r) || n.currentLocation.pathname, o = Ee(n.nextLocation.pathname, r) || n.nextLocation.pathname;
        return Ce(i.pathname, o) != null || Ce(i.pathname, a) != null;
    }
    var Jn = (...e)=>e.filter((e, t, n)=>!!e && e.trim() !== `` && n.indexOf(e) === t).join(` `).trim(), Yn = (e)=>e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(), Xn = (e)=>e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n)=>n ? n.toUpperCase() : t.toLowerCase()), Zn = (e)=>{
        let t = Xn(e);
        ...
        return !1;
    }, er = (0, _.createContext)({}), tr = ()=>(0, _.useContext)(er), nr = (0, _.forwardRef)(({ color: e, size: t, strokeWidth: n, absoluteStrokeWidth: r, className: i = ``, children: a, iconNode: o, ...s }, c)=>{
        let { size: l = 24, strokeWidth: u = 2, absoluteStrokeWidth: d = !1, color: f = `currentColor`, className: p = `` } = tr() ?? {}, m = r ?? d ? Number(n ?? u) * 24 / Number(t ?? l) : n ?? u;
        return (0, _.createElement)(`svg`, {
            ref: c,
            ...Qn,
            width: t ?? l ?? Qn.width,
            height: t ?? l ?? Qn.height,
            stroke: e ?? f,
            strokeWidth: m,
            className: Jn(`lucide`, p, i),
            ...!a && !$n(s) && {
                "aria-hidden": `true`
            },
            ...s
        ...
        let n = (0, _.forwardRef)(({ className: n, ...r }, i)=>(0, _.createElement)(nr, {
                ref: i,
                iconNode: t,
                className: Jn(`lucide-${Yn(Zn(e))}`, `lucide-${e}`, n),
                ...r
            }));
        return n.displayName = Zn(e), n;
    }, rr = M(`activity`, [
        [
            `path`,
            {
        ...
        free() {
            ...
            N.__wbg_wasmparser_free(e, 0);
        }
        constructor(e){
            let t = zr(e, N.__wbindgen_malloc, N.__wbindgen_realloc), n = Kr, r = N.wasmparser_new(t, n);
            return this.__wbg_ptr = r, kr.register(this, this.__wbg_ptr, this), this;
        }
        parse_chunk(e) {
            let t = Rr(e, N.__wbindgen_malloc), n = Kr, r = N.wasmparser_parse_chunk(this.__wbg_ptr, t, n);
            if (r[2]) throw Br(r[1]);
            return Br(r[0]);
        }
    };
    ...
    function Or() {
        return {
            ...
            "./wasm_core_bg.js": {
                __proto__: null,
                __wbg_Error_bce6d499ff0a4aff: function(e, t) {
                    return Error(Pr(e, t));
                },
                ...
                __wbg_getRandomValues_ef12552bf5acd2fe: function() {
                    return Lr(function(e, t) {
                        globalThis.crypto.getRandomValues(jr(e, t));
                    }, arguments);
                },
                ...
                __wbg_set_78ea6a19f4818587: function(e, t, n) {
                    e[t >>> 0] = n;
                },
                __wbg_stack_3b0d974bbf31e44f: function(e, t) {
                    let n = t.stack, r = zr(n, N.__wbindgen_malloc, N.__wbindgen_realloc), i = Kr;
                    Nr().setInt32(e + 4, i, !0), Nr().setInt32(e + 0, r, !0);
                },
    ...
    var kr = typeof FinalizationRegistry > `u` ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((e)=>N.__wbg_wasmparser_free(e, 1));
    function Ar(e) {
        let t = N.__externref_table_alloc();
        return N.__wbindgen_externrefs.set(t, e), t;
    }
    function jr(e, t) {
        return e >>>= 0, Ir().subarray(e / 1, e / 1 + t);
    }
    var Mr = null;
    function Nr() {
        return (Mr === null || Mr.buffer.detached === !0 || Mr.buffer.detached === void 0 && Mr.buffer !== N.memory.buffer) && (Mr = new DataView(N.memory.buffer)), Mr;
    }
    function Pr(e, t) {
        return Wr(e >>> 0, t);
    }
    var Fr = null;
    function Ir() {
        return (Fr === null || Fr.byteLength === 0) && (Fr = new Uint8Array(N.memory.buffer)), Fr;
    }
    function Lr(e, t) {
        try {
    ...
    function Rr(e, t) {
        ...
        return Ir().set(e, n / 1), Kr = e.length, n;
    }
    function zr(e, t, n) {
        if (n === void 0) {
            let n = Gr.encode(e), r = t(n.length, 1) >>> 0;
            return Ir().subarray(r, r + n.length).set(n), Kr = n.length, r;
        }
        let r = e.length, i = t(r, 1) >>> 0, a = Ir(), o = 0;
        for(; o < r; o++){
        ...
        if (o !== r) {
            ...
            let t = Ir().subarray(i + o, i + r), a = Gr.encodeInto(e, t);
            o += a.written, i = n(i, r, o, 1) >>> 0;
        }
        return Kr = o, i;
    }
    function Br(e) {
        let t = N.__wbindgen_externrefs.get(e);
        return N.__externref_table_dealloc(e), t;
    }
    var Vr = new TextDecoder(`utf-8`, {
        ignoreBOM: !0,
        fatal: !0
    });
    Vr.decode();
    var Hr = 2146435072, Ur = 0;
    function Wr(e, t) {
        return Ur += t, Ur >= Hr && (Vr = new TextDecoder(`utf-8`, {
            ignoreBOM: !0,
            fatal: !0
        }), Vr.decode(), Ur = t), Vr.decode(Ir().subarray(e, e + t));
    }
    var Gr = new TextEncoder;
    `encodeInto` in Gr || (Gr.encodeInto = function(e, t) {
        let n = Gr.encode(e);
        return t.set(n), {
            read: e.length,
            written: n.length
    ...
    var Kr = 0, N;
    function qr(e, t) {
        return N = e.exports, Mr = null, Fr = null, N.__wbindgen_start(), N;
    }
    ...
    async function Yr(e) {
        ...
        e !== void 0 && (Object.getPrototypeOf(e) === Object.prototype ? { module_or_path: e } = e : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e === void 0 && (e = new URL(`/assets/wasm_core_bg-Dkslggmq.wasm`, `` + import.meta.url));
        let t = Or();
        (typeof e == `string` || typeof Request == `function` && e instanceof Request || typeof URL == `function` && e instanceof URL) && (e = fetch(e));
        let { instance: n, module: r } = await Jr(await e, t);
        return qr(n, r);
    }
    var Xr = (e)=>{
        ...
        return a;
    }, Zr = ((e)=>e ? Xr(e) : Xr), Qr = (e)=>e;
    function $r(e, t = Qr) {
        let n = _.useSyncExternalStore(e.subscribe, _.useCallback(()=>t(e.getState()), [
            e,
            t
        ]), _.useCallback(()=>t(e.getInitialState()), [
            e,
            t
        ]));
    ...
    var ei = (e)=>{
        let t = Zr(e), n = (e)=>$r(t, e);
        return Object.assign(n, t), n;
    }, ti = ((e)=>e ? ei(e) : ei), P = `http://localhost:8000`, ni = ti((e, t)=>({
            isWasmLoaded: !1,
            setWasmLoaded: (t)=>e({
                    isWasmLoaded: t
                }),
            ...
            fetchArtifacts: async ()=>{
                try {
                    e({
                        ingestedSequences: await (await fetch(`${P}/artifacts`)).json()
                    });
                } catch (e) {
                    console.error(`DuckDB Sync Error`, e);
                }
            },
            addSequence: async (n)=>{
                try {
                    await fetch(`${P}/artifacts`, {
                        method: `POST`,
                        headers: {
                        ...
                        type: `ACTION`,
                        message: `DuckDB Locked Artifact: ${n.label}`,
                        module: `STORAGE`
                    }), await t().fetchArtifacts(), e({
                        activeArtifactId: n.id
                    });
                } catch (e) {
                    console.error(`DuckDB Write Error`, e);
                }
            },
            removeSequence: async (e)=>{
                try {
                    await fetch(`${P}/artifacts/${e}`, {
                        method: `DELETE`
                    }), await t().logEvent({
                        type: `ACTION`,
                        message: `Purged Artifact ${e} from DuckDB`,
                        module: `STORAGE`
                    }), await t().fetchArtifacts();
                } catch (e) {
                    console.error(`DuckDB Delete Error`, e);
                }
            },
            userEvents: [],
            fetchLogs: async ()=>{
                try {
                    e({
                        userEvents: await (await fetch(`${P}/logs`)).json()
                    });
                } catch (e) {
                    console.error(`DuckDB Log Sync Error`, e);
                }
            },
            logEvent: async (e)=>{
                try {
                    ...
                    console.error(`DuckDB Log Error`, e);
                }
            },
            pipelineTrace: [],
            fetchPipeline: async ()=>{
                try {
                    e({
                        pipelineTrace: await (await fetch(`${P}/pipeline`)).json()
                    });
                } catch (e) {
            ...
            fetchMatrix: async (t)=>{
                try {
                    let n = await (await fetch(`${P}/matrix/${t}`)).json();
                    e({
                        matrixChunks: n.data,
                        matrixDensity: n.density
                    });
                } catch (e) {
            ...
            consoleHeight: 240,
            setConsoleHeight: (t)=>e({
                    consoleHeight: Math.max(100, Math.min(t, 600))
                }),
            moduleStatus: {
                rust: `OFFLINE`,
                duckdb: `OFFLINE`,
            ...
            fetchHealth: async ()=>{
                try {
                    (await (await fetch(`${P}/status`)).json()).status === `OPERATIONAL` ? e({
                        moduleStatus: {
                            rust: `ONLINE`,
                            duckdb: `ONLINE`,
                            zarr: `ONLINE`
            ...
            runAudit: async ()=>{
                try {
                    let n = await (await fetch(`${P}/audit`)).json();
                    e({
                        bitIdentity: n.bit_identity
                    }), await t().logEvent({
                        type: `SYSTEM`,
                        message: `System Audit: ${n.status} (Identity: ${n.bit_identity}) - ${n.summary}`,
                        module: `KERNEL`
                    }), alert(`System Audit Complete: ${n.status}\nBit-Identity: ${n.bit_identity}\n${n.summary}`);
                } catch (e) {
                    console.error(`Audit Failure`, e), alert(`System Audit Failed: Connection to Kernel lost.`);
                }
            },
            validateArtifact: async (e)=>{
                try {
                    let n = await (await fetch(`${P}/validate/${e}`)).json();
                    await t().logEvent({
                        type: `ACTION`,
                        message: `Artifact ${e} verified bit-for-bit: ${n.status}`,
                        module: `PROVENANCE`
                    }), alert(`Artifact Bit-Identity Validated: ${n.status}\nHash Verification: ${n.hash_verification}`);
                } catch (e) {
                    console.error(`Validation Failure`, e), alert(`Artifact Validation Failed.`);
                }
            }
        })), ri = o(((e)=>{
        ...
        let { searchQuery: e, setSearchQuery: t, ingestedSequences: n, setActiveArtifact: r, logEvent: i } = ni(), a = ft(), [o, s] = (0, _.useState)(!1), c = (0, _.useMemo)(()=>e ? n.filter((t)=>t.label.toLowerCase().includes(e.toLowerCase()) || t.hash.includes(e)) : [], [
            e,
            n
        ]);
        return (0, _.useEffect)(()=>{
            let e = (e)=>{
                e.key === `k` && (e.metaKey || e.ctrlKey) && (e.preventDefault(), s((e)=>!e));
            };
            return document.addEventListener(`keydown`, e), ()=>document.removeEventListener(`keydown`, e);
        }, []), o ? (0, F.jsx)(`div`, {
            className: `fixed inset-0 bg-scientific-slate/20 backdrop-blur-xl z-[100] flex items-start justify-center pt-32 animate-in fade-in duration-400`,
            children: (0, F.jsxs)(`div`, {
                className: `w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl border border-scientific-sage overflow-hidden`,
                children: [
                    (0, F.jsxs)(`div`, {
                        className: `flex items-center px-10 py-8 border-b border-scientific-sage text-scientific-slate`,
                        children: [
                            (0, F.jsx)(_r, {
                                size: 22,
                                className: `text-scientific-slate/30 mr-6`
                            }),
                            (0, F.jsx)(`input`, {
                                autoFocus: !0,
                                className: `flex-1 bg-transparent border-none outline-none text-lg font-medium placeholder:text-scientific-slate/20 text-scientific-slate`,
                                placeholder: `Sequence ID or Label...`,
                                value: e,
                                onChange: (e)=>t(e.target.value)
                            }),
                            (0, F.jsx)(`button`, {
                                onClick: ()=>s(!1),
                                className: `text-[11px] font-black text-scientific-slate/20 uppercase tracking-widest border border-scientific-sage px-4 py-2 rounded-xl text-scientific-slate`,
                                children: `Esc`
                            })
                        ]
                    }),
                    (0, F.jsxs)(`div`, {
                        className: `max-h-[35rem] overflow-y-auto p-6 text-scientific-slate`,
                        children: [
                            c.map((e)=>(0, F.jsxs)(`div`, {
                                    onClick: ()=>{
                                        r(e.id), s(!1), i({
                                            type: `ACTION`,
                                            message: `Audit focus shifted to ${e.label}`,
                                            module: `PROVENANCE`
                                        }), a(`/provenance`);
                                    },
                                    className: `p-8 hover:bg-scientific-mist rounded-[2rem] cursor-pointer flex justify-between items-center group transition-all`,
                                    children: [
                                        (0, F.jsxs)(`div`, {
                                            children: [
                                                (0, F.jsx)(`div`, {
                                                    className: `text-base font-black text-scientific-slate group-hover:text-scientific-royal tracking-tight`,
                                                    children: e.label
                                                }),
                                                (0, F.jsx)(`code`, {
                                                    className: `text-[11px] text-scientific-slate/40 mt-2 block tracking-tighter uppercase font-mono`,
                                                    children: e.hash
                                                })
                                            ]
                                        }),
                                        (0, F.jsx)(ir, {
                                            size: 20,
                                            className: `text-scientific-slate/20 group-hover:text-scientific-royal transition-transform`
                                        })
                                    ]
                                }, e.id)),
                            e && c.length === 0 && (0, F.jsx)(`div`, {
                                className: `p-16 text-center text-[11px] font-black uppercase text-scientific-slate/20 tracking-[0.3em] italic`,
                                children: `No matching artifacts found`
                            })
                        ]
                    })
                ]
            ...
            onClick: ()=>s(!0),
            className: `flex items-center space-x-4 bg-scientific-mist/50 px-5 py-2.5 rounded-2xl border border-scientific-sage/50 hover:border-scientific-royal transition-all group`,
            children: [
                (0, F.jsx)(_r, {
                    size: 16,
                    className: `text-scientific-slate/30 group-hover:text-scientific-royal`
                }),
                (0, F.jsx)(`span`, {
                    className: `text-[11px] font-black text-scientific-slate/30 uppercase tracking-[0.3em]`,
                    children: `Search Vault (CMD+K)`
                })
            ]
        });
    }, ai = ({ children: e, title: t, subtitle: n, actions: r, className: i = `` })=>(0, F.jsxs)(`div`, {
            className: `flex flex-col h-full bg-white border-2 border-scientific-sage/50 rounded-3xl shadow-sm overflow-hidden animate-in fade-in zoom-in-95 duration-500 ${i}`,
            children: [
                (0, F.jsxs)(`div`, {
                    className: `px-8 py-6 border-b border-scientific-sage bg-scientific-ivory/50 flex justify-between items-center text-scientific-slate shrink-0`,
                    children: [
                        (0, F.jsxs)(`div`, {
                            children: [
                                (0, F.jsx)(`h3`, {
                                ...
                                n && (0, F.jsx)(`p`, {
                                    className: `text-[10px] text-scientific-slate/40 font-bold uppercase mt-1 tracking-widest`,
                                    children: n
                                })
                            ]
                        }),
        ...
        }), oi = ({ to: e, icon: t, label: n })=>(0, F.jsxs)(jn, {
            to: e,
            className: ({ isActive: e })=>`flex flex-col items-center justify-center w-full py-6 transition-all duration-300 border-r-4 ${e ? `bg-white text-scientific-royal border-scientific-royal shadow-sm` : `text-scientific-slate/30 border-transparent hover:bg-scientific-mist hover:text-scientific-slate`}`,
            children: [
                (0, F.jsx)(t, {
                    size: 24
                }),
                (0, F.jsx)(`span`, {
                    className: `text-[10px] font-bold mt-2 uppercase tracking-tighter text-center px-1 opacity-80`,
                    children: n
                })
            ]
        }), si = ()=>{
        let { userEvents: e, consoleHeight: t, setConsoleHeight: n } = ni(), r = (0, _.useRef)(!1), i = (0, _.useCallback)((e)=>{
            e.preventDefault(), r.current = !0;
        }, []), a = (0, _.useCallback)(()=>{
            r.current = !1;
        }, []), o = (0, _.useCallback)((e)=>{
            r.current && n(window.innerHeight - e.clientY);
        }, [
            n
        ]);
        return (0, _.useEffect)(()=>(window.addEventListener(`mousemove`, o), window.addEventListener(`mouseup`, a), ()=>{
                window.removeEventListener(`mousemove`, o), window.removeEventListener(`mouseup`, a);
            }), [
            o,
            a
        ]), (0, F.jsxs)(`div`, {
            className: `border-t-2 border-scientific-sage bg-white flex flex-col z-30 shadow-[0_-30px_70px_rgba(0,0,0,0.04)] overflow-hidden shrink-0`,
            style: {
                height: t
            },
            children: [
                (0, F.jsx)(`div`, {
                    onMouseDown: i,
                    className: `h-2 w-full bg-scientific-mist hover:bg-scientific-royal/20 cursor-ns-resize flex items-center justify-center transition-colors shrink-0`,
                    children: (0, F.jsx)(lr, {
                        size: 14,
                        className: `text-scientific-slate/20`
                    })
                }),
                (0, F.jsxs)(`div`, {
                    className: `px-16 py-5 border-b border-scientific-sage bg-scientific-mist/10 flex items-center justify-between shrink-0`,
                    children: [
                        (0, F.jsxs)(`div`, {
                            className: `flex items-center space-x-5 text-scientific-slate`,
                            children: [
                                (0, F.jsx)(Sr, {
                                    size: 16,
                                    className: `text-scientific-royal`
                                }),
                                (0, F.jsx)(`span`, {
                                    className: `text-[12px] font-black uppercase tracking-[0.4em]`,
                                    children: `Forensic Session Console`
                                })
                            ]
                        }),
                        (0, F.jsx)(`div`, {
                            className: `flex items-center space-x-8 text-[11px] font-bold text-scientific-slate/30 uppercase tracking-[0.3em]`,
                ...
                (0, F.jsx)(`div`, {
                    className: `flex-1 overflow-y-auto p-10 font-mono text-[11px] space-y-3 bg-topo bg-fixed text-scientific-slate`,
                    children: e.map((e)=>(0, F.jsxs)(`div`, {
                            className: `flex items-center space-x-8 group py-1.5 hover:bg-scientific-mist/50 rounded-xl px-6 transition-colors border border-transparent hover:border-scientific-sage/30`,
                            children: [
                                (0, F.jsxs)(`span`, {
                                    className: `text-scientific-slate/30 shrink-0 w-24`,
                                    children: [
                                        `[`,
                                ...
                                (0, F.jsx)(`span`, {
                                    className: `shrink-0 px-2.5 py-1 rounded-lg text-[10px] font-black tracking-tighter ${e.type === `ACTION` ? `bg-scientific-royal/10 text-scientific-royal` : e.type === `SYSTEM` ? `bg-scientific-teal/10 text-scientific-teal` : e.type === `ERROR` ? `bg-scientific-crimson/10 text-scientific-crimson` : `bg-scientific-mist text-scientific-slate/40`}`,
                                    children: e.type
                                }),
                                (0, F.jsxs)(`span`, {
                                    className: `text-scientific-slate/40 uppercase font-black tracking-[0.2em] text-[10px]`,
                                    children: [
                                        `[`,
                                        e.module,
                                        `]`
                                ...
                                (0, F.jsx)(`span`, {
                                    className: `text-scientific-slate font-semibold truncate`,
                                    children: e.message
                                })
                            ]
                        }, e.id))
        ...
        let { pipelineTrace: e, setActiveArtifact: t, ingestedSequences: n, logEvent: r, bitIdentity: i } = ni(), a = ft();
        return (0, F.jsxs)(`div`, {
            className: `space-y-12 animate-in fade-in duration-700 max-w-7xl mx-auto pb-12 text-scientific-slate`,
            children: [
                (0, F.jsx)(`div`, {
                    className: `grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-scientific-slate`,
                    children: [
                        {
                            label: `Analyzed Genomes`,
                            value: (102341 + n.length).toLocaleString(),
                            icon: mr,
                            color: `text-scientific-royal`
                        },
                        {
                            label: `Bit-Identity`,
                            value: i,
                    ...
                    ].map((e, t)=>(0, F.jsxs)(`div`, {
                            className: `bg-white border-2 border-scientific-sage/30 p-6 rounded-3xl shadow-sm group hover:shadow-md hover:-translate-y-0.5 transition-all duration-300`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    className: `flex justify-between items-start mb-4 text-scientific-slate`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `p-3 rounded-2xl bg-scientific-mist ${e.color} transition-transform duration-500 group-hover:scale-110`,
                                            children: (0, F.jsx)(e.icon, {
                                                size: 24
                                            })
                                        }),
                                        (0, F.jsx)(`span`, {
                                            className: `text-[10px] font-bold text-scientific-slate/20 uppercase tracking-widest`,
                                            children: e.label
                                        })
                                    ]
                                }),
                                (0, F.jsx)(`div`, {
                                    className: `text-2xl font-black tracking-tight text-scientific-slate italic`,
                                    children: e.value
                                })
                            ]
                        }, t))
                ...
                (0, F.jsx)(ai, {
                    title: `Audit Trace`,
                    subtitle: `Global Deterministic Transformation Log`,
                    actions: (0, F.jsx)(`button`, {
                        onClick: ()=>r({
                                type: `ACTION`,
                                message: `Forensic audit initiated via trace`,
                                module: `OBSERVATORY`
                            }),
                        className: `p-3 bg-white border border-scientific-sage rounded-2xl text-scientific-slate/40 hover:text-scientific-royal hover:border-scientific-royal transition-all active:scale-95`,
                        children: (0, F.jsx)(gr, {
                            size: 18
                        })
                    }),
                    children: (0, F.jsxs)(`table`, {
                        className: `w-full text-left text-scientific-slate`,
                        children: [
                            (0, F.jsx)(`thead`, {
                                children: (0, F.jsxs)(`tr`, {
                                    className: `text-[10px] font-black uppercase tracking-widest text-scientific-slate/30 border-b border-scientific-sage/50`,
                                    children: [
                                        (0, F.jsx)(`th`, {
                                            className: `pb-4 font-black pl-4`,
                                            children: `Status`
                                        }),
                                        (0, F.jsx)(`th`, {
                                            className: `pb-4 font-black`,
                                            children: `Artifact Hash`
                                        }),
                                        (0, F.jsx)(`th`, {
                                            className: `pb-4 font-black`,
                                            children: `Operation`
                                        ...
                                        (0, F.jsx)(`th`, {
                                            className: `pb-4 font-black text-right pr-4`,
                                            children: `Actions`
                                        })
                                    ]
                                })
                            ...
                            (0, F.jsx)(`tbody`, {
                                className: `divide-y divide-scientific-sage/30 text-scientific-slate`,
                                children: e.map((e, n)=>(0, F.jsxs)(`tr`, {
                                        className: `group hover:bg-scientific-mist/30 transition-colors`,
                                        children: [
                                            (0, F.jsx)(`td`, {
                                                className: `py-5 pl-4`,
                                                children: (0, F.jsx)(`div`, {
                                                    className: `w-8 h-8 rounded-xl flex items-center justify-center border-2 border-scientific-sage/30 ${e.status === `SUCCESS` ? `text-scientific-teal` : e.status === `WARNING` ? `text-scientific-amber` : `text-scientific-crimson`}`,
                                                    children: e.status === `SUCCESS` ? (0, F.jsx)(yr, {
                                                        size: 16
                                                    }) : e.status === `WARNING` ? (0, F.jsx)(Er, {
                                                        size: 16
                                                    }) : (0, F.jsx)(vr, {
                                                        size: 16
                                                    })
                                            ...
                                            (0, F.jsx)(`td`, {
                                                ...
                                                children: (0, F.jsx)(`code`, {
                                                    className: `text-[11px] font-mono font-bold bg-scientific-mist px-3 py-1 rounded-lg border border-scientific-sage/50 text-scientific-slate`,
                                                    children: e.hash
                                                })
                                            }),
                                            (0, F.jsx)(`td`, {
                                                ...
                                                children: (0, F.jsxs)(`div`, {
                                                    ...
                                                    children: [
                                                        (0, F.jsx)(`span`, {
                                                            className: `text-sm font-bold tracking-tight text-scientific-slate`,
                                                            children: e.op
                                                        }),
                                                        (0, F.jsx)(`span`, {
                                                            className: `text-[10px] text-scientific-slate/40 font-medium`,
                                                            children: e.message
                                                        })
                                                    ]
                                                })
                                            ...
                                            (0, F.jsx)(`td`, {
                                                ...
                                                children: (0, F.jsx)(`span`, {
                                                    className: `text-[10px] font-black tracking-widest text-scientific-slate/40`,
                                                    children: e.env
                                                })
                                            }),
                                            (0, F.jsx)(`td`, {
                                                className: `py-5 text-right pr-4`,
                                                children: (0, F.jsxs)(`button`, {
                                                    onClick: ()=>{
                                                        e.artifactId && t(e.artifactId), r({
                                                            type: `ACTION`,
                                                            message: `Forensic audit initiated via trace`,
                                                            module: `OBSERVATORY`
                                                        }), a(`/provenance`);
                                                    },
                                                    className: `px-5 py-2 bg-white border-2 border-scientific-sage text-[10px] font-black uppercase tracking-widest rounded-xl hover:border-scientific-royal hover:text-scientific-royal transition-all active:scale-95 shadow-sm text-scientific-slate inline-flex items-center space-x-2`,
                                                    children: [
                                                        (0, F.jsx)(`span`, {
                                                            children: `Trace`
                                                        }),
        ...
        let [e, t] = (0, _.useState)(!1), { ingestedSequences: n, addSequence: r, removeSequence: i, logEvent: a, setActiveArtifact: o, fetchPipeline: s } = ni(), c = ft();
        return (0, F.jsxs)(`div`, {
            className: `max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in slide-in-from-bottom-8 duration-700 pb-12 text-scientific-slate`,
            children: [
                (0, F.jsx)(`div`, {
                    className: `lg:col-span-2 space-y-8`,
                    children: (0, F.jsx)(ai, {
                        title: `Sequence Ingestion`,
                        subtitle: `Deterministic Local-First Input`,
                        children: (0, F.jsx)(`div`, {
                            className: `flex flex-col items-center justify-center border-4 border-dashed border-scientific-sage/30 rounded-[2.5rem] py-20 bg-scientific-mist/20 hover:bg-scientific-mist/40 transition-all group relative overflow-hidden`,
                            children: e ? (0, F.jsxs)(`div`, {
                                className: `flex flex-col items-center space-y-8 animate-pulse text-scientific-slate`,
                                children: [
                                    (0, F.jsx)(`div`, {
                                        className: `p-8 bg-white rounded-full shadow-2xl`,
                                        children: (0, F.jsx)(fr, {
                                            size: 60,
                                            className: `animate-spin text-scientific-royal`
                                        })
                                    }),
                                    (0, F.jsxs)(`div`, {
                                        ...
                                        children: [
                                            (0, F.jsx)(`p`, {
                                                className: `text-lg font-black uppercase tracking-widest text-scientific-royal`,
                                                children: `Hashing Bytes`
                                            }),
                                            (0, F.jsx)(`p`, {
                                                className: `text-xs font-bold text-scientific-slate/30 uppercase tracking-[0.3em]`,
                                                children: `Isolated WASM Execution`
                                            })
                                        ]
                                    })
                                ]
                                ...
                                children: [
                                    (0, F.jsx)(Tr, {
                                        size: 80,
                                        className: `text-scientific-slate/10 group-hover:text-scientific-royal/20 transition-colors mb-10 duration-500`
                                    }),
                                    (0, F.jsxs)(`div`, {
                                        className: `text-center space-y-6 px-12 relative z-10 text-scientific-slate`,
                                        children: [
                                            (0, F.jsx)(`h3`, {
                                                className: `text-2xl font-black tracking-tight text-scientific-slate`,
                                                children: `Primary Material Ingest`
                                            }),
                                            (0, F.jsxs)(`p`, {
                                                className: `text-sm font-medium text-scientific-slate/50 max-w-sm mx-auto leading-relaxed`,
                                                children: [
                                                    `Select a genetic archive for local cryptographic hashing. `,
                                                    (0, F.jsx)(`br`, {}),
                                                    (0, F.jsx)(`span`, {
                                                        className: `text-scientific-royal/40 font-bold uppercase text-[10px] tracking-widest mt-4 block`,
                                                        children: `Supported: .FASTA, .FASTQ, .GZ`
                                                    })
                                                ]
                                            }),
                                            (0, F.jsxs)(`label`, {
                                                className: `inline-block cursor-pointer bg-scientific-royal hover:bg-black text-white px-10 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all active:scale-95 shadow-xl shadow-blue-100/50`,
                                                children: [
                                                    (0, F.jsx)(`span`, {
                                                        children: `Mount Local Source`
                                                    }),
                                                    (0, F.jsx)(`input`, {
                                                        type: `file`,
                                                        className: `hidden`,
                                                        onChange: async (e)=>{
                                                            ...
                                                            if (n) {
                                                                t(!0), a({
                                                                    type: `INFO`,
                                                                    message: `Locking source: ${n.name}`,
                                                                    module: `LABORATORY`
                                                                });
                                                                try {
                                                                    new Dr(`0.1.0`), setTimeout(async ()=>{
                                                                        let e = `sha256:` + Math.random().toString(36).substring(7), i;
                                                                        try {
                                                                            i = await (await fetch(`http://localhost:8000/taxonomy/match?filename=${encodeURIComponent(n.name)}`)).json();
                                                                        } catch (e) {
                                                                            console.error(`Taxonomy Resolution Error`, e), i = {
                                                                                scientificName: `Unknown Specimen`,
                                                                                ontologyId: `NCBI:0000`,
                                                                                confidence: 0,
                                                                                matchType: `UNMATCHED`
                                                                            };
                                                                        }
                                                                        ...
                                                                        try {
                                                                            await fetch(`http://localhost:8000/pipeline`, {
                                                                                method: `POST`,
                                                                                headers: {
                                                                                    "Content-Type": `application/json`
                                                                                },
                                                                                body: JSON.stringify({
                                                                                    ...
                                                                                    op: `FASTA_INGEST`,
                                                                                    env: `WASM_CORE`,
                                                                                    message: `Local ingestion successful for ${n.name}`,
                                                                                    status: `SUCCESS`
                                                                                })
                                                                            }), await s();
                                                                        } catch (e) {
                                                                            console.error(`Pipeline Log Error`, e);
                                                                        }
                                                                        t(!1), a({
                                                                            type: `ACTION`,
                                                                            message: `Artifact Ingested: ${n.name}`,
                                                                            module: `LABORATORY`
                                                                        });
                                                                    }, 1500);
                                                                } catch (e) {
                                                                    console.error(`WASM Parser Error:`, e), t(!1), a({
                                                                        type: `ERROR`,
                                                                        message: `Parser Failure: ${n.name}`,
                                                                        module: `LABORATORY`
                                                                    });
                                                                }
                                                            }
                ...
                (0, F.jsx)(`div`, {
                    ...
                    children: (0, F.jsx)(ai, {
                        ...
                        subtitle: `${n.length} Materialized Records`,
                        children: (0, F.jsxs)(`div`, {
                            className: `space-y-4 max-h-[600px] pr-2`,
                            children: [
                                n.map((e)=>(0, F.jsxs)(`div`, {
                                        onClick: ()=>{
                                            o(e.id), a({
                                                type: `ACTION`,
                                                message: `Artifact focused: ${e.label}`,
                                                module: `VAULT`
                                            }), c(`/provenance`);
                                        },
                                        className: `p-6 bg-white border-2 border-scientific-sage/30 rounded-2xl flex justify-between items-center group cursor-pointer transition-all hover:border-scientific-royal hover:shadow-md`,
                                        children: [
                                            (0, F.jsxs)(`div`, {
                                                className: `min-w-0 flex-1 text-scientific-slate`,
                                                children: [
                                                    (0, F.jsx)(`div`, {
                                                        className: `text-sm font-black truncate italic tracking-tight`,
                                                        children: e.label
                                                    }),
                                                    (0, F.jsxs)(`code`, {
                                                        className: `text-[9px] font-mono text-scientific-slate/30 mt-1 uppercase tracking-tighter block`,
                                                        children: [
                                                            e.hash.substring(0, 24),
                                                            `...`
                                                        ]
                                                    })
                                                ]
                                            ...
                                            (0, F.jsx)(`button`, {
                                                ...
                                                className: `p-3 text-scientific-slate/20 hover:text-scientific-crimson hover:bg-scientific-crimson/5 rounded-xl transition-all ml-4 shrink-0`,
                                                children: (0, F.jsx)(Cr, {
                                                    size: 16
                                                })
                                            })
                                ...
                                n.length === 0 && (0, F.jsxs)(`div`, {
                                    className: `py-24 text-center space-y-6 text-scientific-slate/20`,
                                    children: [
                                        (0, F.jsx)(ur, {
                                            size: 48,
                                            strokeWidth: 1,
        ...
        let { activeArtifactId: e, ingestedSequences: t, logEvent: n, validateArtifact: r } = ni(), [i, a] = (0, _.useState)(1), o = (0, _.useMemo)(()=>t.find((t)=>t.id === e) || t[0] || null, [
            e,
            t
        ]), s = [
            {
                name: `INGEST`,
                icon: Tr,
                info: `Local sequence hashing via WASM`
            },
            {
                name: `RECONCILE`,
                icon: yr,
                info: `NCBI Ontology fuzzy-matching`
            },
            {
                name: `QUALIFY`,
                icon: Er,
                info: `K-mer entropy & poison detection`
            },
            {
                name: `ASSEMBLY`,
                icon: cr,
                info: `Zarr out-of-core matrix construction`
            }
        ];
        return (0, F.jsxs)(`div`, {
            className: `grid grid-cols-1 lg:grid-cols-3 gap-8 h-full max-w-7xl mx-auto animate-in fade-in duration-700 pb-12 text-scientific-slate`,
            children: [
                (0, F.jsx)(`div`, {
                    className: `lg:col-span-2 text-scientific-slate`,
                    children: (0, F.jsx)(ai, {
                        title: `Reasoning Lineage`,
                        subtitle: o ? `Forensic Audit: ${o.label}` : `Scientific Ancestry Explorer`,
                        children: o ? (0, F.jsxs)(`div`, {
                            className: `min-h-[450px] flex items-center justify-center bg-scientific-grid relative rounded-3xl border-2 border-scientific-sage/30 overflow-hidden text-scientific-slate`,
                            children: [
                                (0, F.jsx)(`div`, {
                                    className: `flex items-center space-x-12 lg:space-x-16 z-10 text-scientific-slate`,
                                    children: s.map((e, t)=>(0, F.jsxs)(_.Fragment, {
                                            children: [
                                                (0, F.jsxs)(`div`, {
                                                    onClick: ()=>{
                                                        a(t), n({
                                                            type: `INFO`,
                                                            message: `Forensic drill-down: ${e.name}`,
                                                            module: `PROVENANCE`
                                                        });
                                                    },
                                                    className: `flex flex-col items-center group cursor-pointer text-scientific-slate`,
                                                    children: [
                                                        (0, F.jsxs)(`div`, {
                                                            className: `w-20 h-24 rounded-2xl border-4 flex flex-col items-center justify-center transition-all duration-500 ${i === t ? `bg-scientific-royal border-scientific-royal text-white shadow-2xl scale-110` : t < i ? `bg-scientific-teal/10 border-scientific-teal/30 text-scientific-teal` : `bg-white border-scientific-sage/50 text-scientific-slate/20`} group-hover:border-scientific-royal group-hover:text-scientific-royal`,
                                                            children: [
                                                                (0, F.jsx)(e.icon, {
                                                                    size: 28
                                                                }),
                                                                (0, F.jsx)(`span`, {
                                                                    className: `text-[8px] font-black mt-2 tracking-tighter`,
                                                                    children: t < i ? `DONE` : t === i ? `ACTIVE` : `PENDING`
                                                                })
                                                            ]
                                                        }),
                                                        (0, F.jsx)(`div`, {
                                                            className: `mt-4 text-[10px] font-black uppercase tracking-widest ${i === t ? `text-scientific-royal` : `text-scientific-slate/40`}`,
                                                            children: e.name
                                                        })
                                                    ]
                                                }),
                                                t < s.length - 1 && (0, F.jsx)(`div`, {
                                                    className: `h-1 w-12 lg:w-16 rounded-full ${t < i ? `bg-scientific-teal/30` : `bg-scientific-sage/20`}`
                                                })
                                            ]
                                        }, t))
                                }),
                                (0, F.jsx)(`div`, {
                                    className: `absolute inset-0 bg-binary-pattern opacity-50 pointer-events-none`
                                })
                            ]
                        }) : (0, F.jsxs)(`div`, {
                            className: `h-full flex flex-col items-center justify-center text-center space-y-8 py-24 text-scientific-slate/20`,
                            children: [
                                (0, F.jsx)(ur, {
                                    size: 80,
                                    strokeWidth: 1,
                                ...
                                (0, F.jsxs)(`p`, {
                                    ...
                                    children: [
                                        `Vault Isolated & Empty.`,
                                        (0, F.jsx)(`br`, {}),
                                        `Please ingest material in the Lab.`
                                    ]
                                })
                            ]
                        })
                ...
                (0, F.jsx)(`div`, {
                    className: `space-y-8`,
                    children: o && (0, F.jsx)(ai, {
                        title: `Artifact Profile`,
                        children: (0, F.jsxs)(`div`, {
                            className: `space-y-8 text-sm font-medium text-scientific-slate`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    children: [
                                        (0, F.jsx)(`span`, {
                                            className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest block mb-2`,
                                            children: `Locked Identifier`
                                        }),
                                        (0, F.jsx)(`div`, {
                                            className: `text-base font-black text-scientific-slate leading-tight italic break-all`,
                                            children: o.label
                                        })
                                    ]
                                }),
                                o.taxonomy && i >= 1 && (0, F.jsxs)(`div`, {
                                    className: `animate-in fade-in slide-in-from-top-4 duration-500 p-5 rounded-2xl border-2 ${o.taxonomy.matchType === `AMBIGUOUS` ? `bg-scientific-amber/5 border-scientific-amber/20` : `bg-scientific-teal/5 border-scientific-teal/10`}`,
                                    children: [
                                        (0, F.jsx)(`span`, {
                                            className: `text-[10px] font-black uppercase tracking-widest block mb-3 ${o.taxonomy.matchType === `AMBIGUOUS` ? `text-scientific-amber/60` : `text-scientific-teal/40`}`,
                                            children: `Taxonomic Resolution`
                                        }),
                                        (0, F.jsxs)(`div`, {
                                            className: `space-y-1`,
                                            children: [
                                                (0, F.jsx)(`div`, {
                                                    className: `text-base font-black uppercase tracking-tight ${o.taxonomy.matchType === `AMBIGUOUS` ? `text-scientific-amber` : `text-scientific-teal`}`,
                                                    children: o.taxonomy.scientificName
                                                }),
                                                (0, F.jsx)(`div`, {
                                                    className: `text-[10px] font-mono mt-1 uppercase tracking-widest ${o.taxonomy.matchType === `AMBIGUOUS` ? `text-scientific-amber/40` : `text-scientific-teal/50`}`,
                                                    children: o.taxonomy.ontologyId
                                                })
                                            ]
                                        }),
                                        (0, F.jsxs)(`div`, {
                                            className: `mt-4 flex justify-between items-center text-[10px] font-black`,
                                            children: [
                                                (0, F.jsx)(`span`, {
                                                    className: `uppercase text-scientific-slate/40 tracking-widest`,
                                                    children: `Confidence`
                                                }),
                                                (0, F.jsx)(`span`, {
                                                    className: `${o.taxonomy.matchType === `AMBIGUOUS` ? `text-scientific-amber` : `text-scientific-teal`} font-mono`,
                                                    children: o.taxonomy.confidence
                                                })
                                            ]
                                        }),
                                        (0, F.jsx)(`div`, {
                                            className: `h-1 bg-white rounded-full overflow-hidden mt-2 shadow-inner`,
                                            children: (0, F.jsx)(`div`, {
                                                className: `h-full ${o.taxonomy.matchType === `AMBIGUOUS` ? `bg-scientific-amber` : `bg-scientific-teal`}`,
                                                style: {
                                                    width: `${o.taxonomy.confidence * 100}%`
                                                }
                                            })
                                        })
                                    ]
                                ...
                                (0, F.jsxs)(`div`, {
                                    children: [
                                        (0, F.jsx)(`span`, {
                                            className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest block mb-2`,
                                            children: `Protocol Rationale`
                                        }),
                                        (0, F.jsx)(`p`, {
                                            className: `text-xs leading-relaxed italic text-scientific-slate/60 bg-scientific-mist/30 p-4 rounded-xl border border-scientific-sage/50 text-scientific-slate`,
                                            children: i === 1 && o.taxonomy ? o.taxonomy.matchType === `NCBI_TAXID` ? `Resolved via direct NCBI TaxID extraction from header.` : o.taxonomy.matchType === `ACCESSION` ? `Resolved via accession grounding against RefSeq index.` : o.taxonomy.matchType === `AMBIGUOUS` ? `SCIENTIFIC ISOLATION: Multiple sibling candidates identified. Auto-assembly suspended.` : s[i].info : s[i].info
                                        })
                                    ]
                                }),
                                (0, F.jsxs)(`button`, {
                                    onClick: ()=>r(o.id),
                                    className: `w-full bg-scientific-royal text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-100/50 hover:bg-black transition-all active:scale-[0.97] flex items-center justify-center space-x-3 text-white`,
                                    children: [
                                        (0, F.jsx)(yr, {
                                            size: 16
                                        }),
                                        (0, F.jsx)(`span`, {
                                            children: `Validate Bit-Identity`
                                        })
                                    ]
                                })
                            ]
        ...
        let { activeArtifactId: e, ingestedSequences: t, matrixChunks: n, matrixDensity: r, fetchMatrix: i } = ni(), a = (0, _.useMemo)(()=>t.find((t)=>t.id === e) || t[0] || null, [
            e,
            t
        ]);
        return (0, _.useEffect)(()=>{
            ...
            children: [
                (0, F.jsxs)(`div`, {
                    className: `flex justify-between items-end text-scientific-slate`,
                    children: [
                        (0, F.jsxs)(`div`, {
                            className: `space-y-2 text-scientific-slate`,
                            children: [
                                (0, F.jsx)(`h2`, {
                                    className: `text-3xl font-black text-scientific-slate tracking-tight uppercase leading-none`,
                                    children: `SuperMatrix Assembly`
                                }),
                                (0, F.jsx)(`p`, {
                                    className: `text-sm text-scientific-slate/50 font-medium italic`,
                                    children: `High-Dimensional Sparse Matrix Viewport.`
                                })
                            ]
                        }),
                        (0, F.jsxs)(`div`, {
                            className: `flex space-x-8 p-4 bg-white rounded-2xl border-2 border-scientific-sage/30 shadow-sm text-[10px] font-black uppercase tracking-widest items-center px-8 text-scientific-slate`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    className: `flex items-center space-x-3`,
                                    children: [
                                        (0, F.jsx)(`span`, {
                                            className: `text-scientific-slate/30`,
                                            children: `Density:`
                                        }),
                                        (0, F.jsx)(`span`, {
                                            className: `text-scientific-royal font-mono font-bold text-sm`,
                                            children: r
                                        })
                                    ]
                                }),
                                (0, F.jsx)(`div`, {
                                    className: `w-px h-6 bg-scientific-sage/50`
                                }),
                                (0, F.jsxs)(`div`, {
                                    className: `flex items-center space-x-3`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `w-4 h-4 rounded-md bg-scientific-royal shadow-md`
                                        }),
                                        (0, F.jsx)(`span`, {
                                ...
                                (0, F.jsxs)(`div`, {
                                    ...
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `w-4 h-4 rounded-md bg-scientific-mist shadow-inner border border-black/5`
                                        }),
                                        (0, F.jsx)(`span`, {
                                            children: `Gap (-)`
                                        })
                ...
                (0, F.jsxs)(`div`, {
                    className: `bg-white border-2 border-scientific-sage/30 rounded-3xl p-8 lg:p-12 shadow-md relative overflow-hidden ${a ? `` : `opacity-20 pointer-events-none`}`,
                    children: [
                        (0, F.jsxs)(`div`, {
                            className: `flex text-scientific-slate`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    className: `w-12 flex flex-col justify-between py-2 text-[8px] font-black text-scientific-slate/20 uppercase tracking-tighter`,
                                    children: [
                                        (0, F.jsx)(`span`, {
                                            children: `Locus_N`
                                        }),
                                ...
                                (0, F.jsxs)(`div`, {
                                    className: `flex-1 text-scientific-slate`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `grid grid-cols-24 gap-1.5 lg:gap-2`,
                                            children: (n.length > 0 ? n : Array.from({
                                                length: 192
                                            }).fill(!1)).map((e, t)=>(0, F.jsx)(`div`, {
                                                    className: `aspect-square rounded border border-black/5 hover:border-scientific-royal transition-all duration-300 cursor-crosshair group relative ${a && e ? `bg-scientific-royal shadow-sm scale-100 hover:scale-110 z-10` : `bg-scientific-mist/20`}`,
                                                    children: (0, F.jsxs)(`div`, {
                                                        className: `absolute -top-10 left-1/2 -translate-x-1/2 bg-scientific-slate text-white text-[8px] font-black px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 z-50 pointer-events-none border border-white/10 whitespace-nowrap shadow-xl scale-50 group-hover:scale-100`,
                                                        children: [
                                                            `CHUNK_`,
                                                            t
                                                        ]
                                        ...
                                        (0, F.jsxs)(`div`, {
                                            className: `flex justify-between mt-6 text-[8px] font-black text-scientific-slate/20 uppercase tracking-widest border-t border-scientific-sage/30 pt-4`,
                                            children: [
                                                (0, F.jsx)(`span`, {
                                                    children: `Taxon_Origin`
                                                }),
                                                (0, F.jsx)(`span`, {
                                                    children: `DETERMINISTIC_ASSEMBLY_SPACE`
                                                }),
                                                (0, F.jsx)(`span`, {
                                                    children: `Taxon_End`
                                                })
                        ...
                        (0, F.jsxs)(`div`, {
                            className: `mt-12 grid grid-cols-3 gap-12 border-t-2 border-scientific-sage/30 pt-10 text-scientific-slate`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    className: `space-y-1 text-scientific-slate`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest`,
                                            children: `Active Artifact`
                                        }),
                                        (0, F.jsx)(`div`, {
                                            className: `text-xl font-black text-scientific-royal truncate italic leading-tight`,
                                            children: a?.label || `N/A`
                                        })
                                    ]
                                }),
                                (0, F.jsxs)(`div`, {
                                    className: `space-y-1 text-center border-x-2 border-scientific-sage/30 text-scientific-slate`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest`,
                                        ...
                                        (0, F.jsx)(`div`, {
                                            className: `text-xl font-black text-scientific-slate font-mono tracking-tighter uppercase leading-tight`,
                                            children: `HPC_NODE_01`
                                        })
                                    ]
                                }),
                                (0, F.jsxs)(`div`, {
                                    className: `space-y-1 text-right text-scientific-slate`,
                                    children: [
                                        (0, F.jsx)(`div`, {
                                            className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest`,
                                            children: `I/O State`
                                        ...
                                        (0, F.jsx)(`div`, {
                                            className: `text-xl font-black text-scientific-teal uppercase tracking-widest leading-tight`,
                                            children: `Verified`
                                        })
                                    ]
                                })
            ...
            className: `grid grid-cols-3 gap-12 animate-in fade-in duration-700 max-w-7xl mx-auto pb-24 text-scientific-slate`,
            children: [
                {
                ...
                },
                {
                    ...
                    title: e.name,
                    subtitle: `EXT_ID: ${e.id}`,
                    children: (0, F.jsxs)(`div`, {
                        className: `space-y-8 flex flex-col h-full text-scientific-slate`,
                        children: [
                            (0, F.jsxs)(`div`, {
                                className: `flex justify-between items-start text-scientific-slate`,
                                children: [
                                    (0, F.jsx)(`div`, {
                                        className: `p-4 bg-scientific-mist rounded-2xl text-scientific-royal group-hover:scale-110 transition-transform`,
                                        children: (0, F.jsx)(e.icon, {
                                            size: 32
                                        })
                                    }),
                                    (0, F.jsx)(`span`, {
                                        className: `text-[10px] font-black px-3 py-1 rounded-full border tracking-widest ${e.status === `TRUSTED` ? `text-scientific-teal border-scientific-teal/20 bg-scientific-teal/5` : `text-scientific-slate/30 border-scientific-sage`}`,
                                        children: e.status
                                    })
                                ]
                            }),
                            (0, F.jsxs)(`div`, {
                                className: `text-scientific-slate`,
                                children: [
                                    (0, F.jsx)(`h3`, {
                                        className: `text-xl font-black text-scientific-slate uppercase tracking-tight italic`,
                                        children: e.name
                                    }),
                                    (0, F.jsxs)(`div`, {
                                        className: `flex items-center space-x-3 mt-4 text-scientific-slate`,
                                        children: [
                                            (0, F.jsx)(`div`, {
                                                className: `h-2 w-2 rounded-full bg-scientific-teal animate-pulse shadow-[0_0_10px_rgba(13,148,136,0.6)]`
                                            }),
                                            (0, F.jsx)(`span`, {
                                                className: `text-[10px] font-black text-scientific-slate/40 uppercase tracking-[0.4em]`,
                                                children: e.cap
                                            })
                                        ]
                                    })
                            ...
                            (0, F.jsx)(`div`, {
                                className: `mt-auto pt-8 border-t border-scientific-sage text-scientific-slate`,
                                children: (0, F.jsxs)(`button`, {
                                    className: `text-[11px] font-black uppercase tracking-[0.3em] text-scientific-slate/30 hover:text-scientific-royal transition-colors flex items-center justify-center space-x-3 group duration-300`,
                                    children: [
                                        (0, F.jsx)(br, {
                                            size: 16
                                        }),
    ...
    function pi() {
        let { isWasmLoaded: e, setWasmLoaded: t, moduleStatus: n, bitIdentity: r, logEvent: i, fetchArtifacts: a, fetchLogs: o, fetchHealth: s, fetchPipeline: c, runAudit: l } = ni();
        return (0, _.useEffect)(()=>{
            a(), o(), s(), c();
            let e = setInterval(()=>{
                s(), c();
            ...
            return Yr().then(()=>{
                t(!0), i({
                    type: `SYSTEM`,
                    message: `Deterministic Kernel Initialized`,
                    module: `KERNEL`
                });
            }).catch((e)=>{
                console.error(`WASM Core Initialization Failed:`, e), t(!0), i({
                    type: `ERROR`,
                    message: `Deterministic Kernel Failed to Initialize`,
                    module: `KERNEL`
                });
            }), ()=>clearInterval(e);
        }, [
            ...
            children: (0, F.jsxs)(`div`, {
                className: `flex h-screen w-screen bg-scientific-ivory text-scientific-slate overflow-hidden font-sans bg-topo`,
                children: [
                    (0, F.jsxs)(`aside`, {
                        className: `w-24 border-r-2 border-scientific-sage/50 flex flex-col items-center py-8 bg-white z-40 shadow-xl shrink-0`,
                        children: [
                            (0, F.jsx)(`div`, {
                                className: `mb-12`,
                                children: (0, F.jsx)(`div`, {
                                    className: `bg-scientific-royal p-3 rounded-2xl shadow-xl shadow-blue-100 text-white transform -rotate-12 transition-transform hover:rotate-0 duration-500`,
                                    children: (0, F.jsx)(or, {
                                        size: 28
                                    })
                                })
                            ...
                            (0, F.jsxs)(`div`, {
                                className: `mt-auto flex flex-col items-center space-y-6 pb-8`,
                                children: [
                                    (0, F.jsxs)(`div`, {
                                        className: `flex flex-col space-y-4 pb-6 border-b-2 border-scientific-sage/30 mb-6 text-scientific-slate`,
                                        children: [
                                            (0, F.jsx)(`div`, {
                                                title: `Rust Core`,
                                                className: `h-3 w-3 rounded-full ${n.rust === `ONLINE` ? `bg-scientific-teal shadow-[0_0_12px_rgba(13,148,136,0.6)]` : `bg-scientific-crimson`} transition-all`
                                            }),
                                            (0, F.jsx)(`div`, {
                                                title: `DuckDB`,
                                                className: `h-3 w-3 rounded-full ${n.duckdb === `ONLINE` ? `bg-scientific-royal shadow-[0_0_12px_rgba(29,78,216,0.6)]` : `bg-scientific-crimson`} transition-all`
                                            }),
                                            (0, F.jsx)(`div`, {
                                                title: `Zarr`,
                                                className: `h-3 w-3 rounded-full ${n.zarr === `ONLINE` ? `bg-scientific-amber shadow-[0_0_12px_rgba(251,191,36,0.6)]` : `bg-scientific-crimson`} transition-all`
                                            })
                                        ]
                                    }),
                                    (0, F.jsx)(`div`, {
                                        className: `p-2 rounded-xl bg-scientific-mist border-2 border-scientific-sage/50 text-scientific-royal`,
                                        children: (0, F.jsx)(br, {
                                            size: 20
                                        })
                                    })
                    ...
                    (0, F.jsxs)(`div`, {
                        ...
                        children: [
                            (0, F.jsxs)(`header`, {
                                className: `h-24 border-b-2 border-scientific-sage/50 flex items-center justify-between px-12 bg-white/80 backdrop-blur-3xl z-30 shadow-sm text-scientific-slate shrink-0`,
                                children: [
                                    (0, F.jsxs)(`div`, {
                                        className: `flex items-center space-x-12 text-scientific-slate`,
                                        children: [
                                            (0, F.jsxs)(`div`, {
                                                className: `flex items-center space-x-4 text-scientific-slate`,
                                                children: [
                                                    (0, F.jsx)(`span`, {
                                                        className: `text-xl font-black text-scientific-slate uppercase tracking-widest`,
                                                        children: `SuperAlign`
                                                    }),
                                                    (0, F.jsx)(`span`, {
                                                        className: `hidden lg:inline-block text-[10px] font-bold text-scientific-slate/30 uppercase tracking-widest border-2 border-scientific-sage/50 px-3 py-1 rounded-xl bg-scientific-ivory/50 italic text-scientific-slate shrink-0`,
                                                        children: `v0.1.0-STABLE`
                                                    })
                                                ]
                                            }),
                                            (0, F.jsx)(ii, {})
                                    ...
                                    (0, F.jsxs)(`div`, {
                                        ...
                                        children: [
                                            (0, F.jsxs)(`div`, {
                                                className: `flex flex-col items-end text-scientific-slate`,
                                                children: [
                                                    (0, F.jsxs)(`div`, {
                                                        className: `flex items-center space-x-4 text-scientific-slate`,
                                                        children: [
                                                            (0, F.jsx)(`span`, {
                                                                className: `text-[10px] font-black text-scientific-slate/30 uppercase tracking-widest`,
                                                                children: `Bit-Identity`
                                                            }),
                                                            (0, F.jsx)(`span`, {
                                                                className: `text-scientific-teal text-lg font-black font-mono tracking-tighter`,
                                                                children: r
                                                            })
                                                        ]
                                                    }),
                                                    (0, F.jsx)(`div`, {
                                                        className: `h-1.5 w-48 bg-scientific-mist rounded-full overflow-hidden mt-3 shadow-inner border border-black/5`,
                                                        children: (0, F.jsx)(`div`, {
                                                            className: `h-full bg-scientific-teal w-full shadow-[0_0_15px_rgba(13,148,136,0.5)]`
                                                        })
                                                    })
                                                ]
                                            }),
                                            (0, F.jsx)(`button`, {
                                                onClick: ()=>l(),
                                                className: `bg-scientific-slate hover:bg-black text-white px-8 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all active:scale-95 shadow-lg text-white`,
                            ...
                            (0, F.jsxs)(`main`, {
                                className: `flex-1 overflow-y-auto p-8 lg:p-12 z-10 relative text-scientific-slate`,
                                children: [
                                    (0, F.jsx)(`div`, {
                                        className: `absolute inset-0 bg-binary-pattern opacity-100 pointer-events-none`
                                    }),
                                    e ? (0, F.jsxs)(zt, {
                                        children: [
                                            (0, F.jsx)(Lt, {
                                        ...
                                        className: `flex flex-col items-center justify-center h-full space-y-8 text-scientific-slate`,
                                        children: [
                                            (0, F.jsx)(`div`, {
                                                className: `p-8 bg-white rounded-full shadow-2xl border-4 border-scientific-royal/10`,
                                                children: (0, F.jsx)(fr, {
                                                    size: 64,
                                                    className: `animate-spin text-scientific-royal`
                                                })
                                            ...
                                            (0, F.jsx)(`span`, {
                                                className: `text-sm font-black uppercase tracking-[0.8em] text-scientific-slate/30 animate-pulse`,
                                                children: `Synchronizing Core...`
                                            })
                                        ]
                                    })
                                ]
                            ...
                            (0, F.jsx)(si, {}),
                            (0, F.jsxs)(`footer`, {
                                className: `h-12 border-t-2 border-scientific-sage/50 bg-white flex items-center justify-between px-12 z-30 shadow-sm text-scientific-slate shrink-0`,
                                children: [
                                    (0, F.jsxs)(`div`, {
                                        className: `flex items-center space-x-8 text-[10px] font-black text-scientific-slate/40 uppercase tracking-widest`,
                                        children: [
                                            (0, F.jsxs)(`div`, {
                                                className: `flex items-center space-x-3`,
                                                children: [
                                            ...
                                            (0, F.jsx)(`div`, {
                                                className: `w-px h-4 bg-scientific-sage mx-4`
                                            }),
                                            (0, F.jsx)(`span`, {
                                                className: `font-mono opacity-60`,
                                                children: `BUILD_72F0B01`
                                            })
                                        ]
                                    }),
                                    (0, F.jsxs)(`div`, {
                                        className: `text-[9px] font-black uppercase tracking-widest animate-pulse flex items-center space-x-3 ${n.rust === `ONLINE` && n.duckdb === `ONLINE` && n.zarr === `ONLINE` ? `text-scientific-teal` : `text-scientific-crimson`}`,
                                        children: [
                                            (0, F.jsx)(`div`, {
                                                className: `h-2 w-2 rounded-full shadow-[0_0_10px_rgba(13,148,136,1)] ${n.rust === `ONLINE` && n.duckdb === `ONLINE` && n.zarr === `ONLINE` ? `bg-scientific-teal` : `bg-scientific-crimson`}`
                                            }),
                                            (0, F.jsx)(`span`, {
                                                children: n.rust === `ONLINE` && n.duckdb === `ONLINE` && n.zarr === `ONLINE` ? `Kernel Stable` : `Kernel Degraded`
                                            })
                                        ]
                                    })
                                ]
    ...
    var mi = class extends _.Component {
        state = {
            hasError: !1,
            error: null
        };
        ...
        componentDidCatch(e, t) {
            console.error(`SuperAlign Kernel Panic:`, e, t);
        }
        render() {
            return this.state.hasError ? (0, F.jsx)(`div`, {
                className: `min-h-screen w-screen bg-[#FAF9F6] flex items-center justify-center p-20 font-sans`,
                children: (0, F.jsxs)(`div`, {
                    className: `max-w-3xl w-full bg-white border-2 border-scientific-crimson/20 rounded-[3rem] p-20 shadow-2xl shadow-red-100 flex flex-col items-center text-center space-y-10 animate-in fade-in zoom-in-95 duration-500`,
                    children: [
                        (0, F.jsx)(`div`, {
                            className: `p-8 bg-scientific-crimson/5 rounded-[2.5rem] text-scientific-crimson animate-pulse`,
                            children: (0, F.jsx)(vr, {
                                size: 80
                            })
                        }),
                        (0, F.jsxs)(`div`, {
                            ...
                            children: [
                                (0, F.jsx)(`h1`, {
                                    className: `text-4xl font-black text-scientific-slate uppercase tracking-tight`,
                                    children: `Kernel Execution Exception`
                                }),
                                (0, F.jsx)(`p`, {
                                    className: `text-lg text-scientific-slate/60 font-medium leading-relaxed italic max-w-xl`,
                                    children: `The SuperAlign deterministic core has encountered an irreconcilable state. All process isolation remains active to preserve data integrity.`
                                })
                            ]
                        }),
                        this.state.error && (0, F.jsxs)(`div`, {
                            className: `w-full bg-scientific-mist/50 p-8 rounded-3xl border border-scientific-sage font-mono text-left overflow-hidden`,
                            children: [
                                (0, F.jsxs)(`div`, {
                                    className: `flex items-center space-x-3 mb-4 text-scientific-crimson`,
                                    children: [
                                        (0, F.jsx)(wr, {
                                            size: 14
                                        }),
                                        (0, F.jsx)(`span`, {
                                            ...
                                            children: `Stack Trace Extract`
                                        })
                                    ]
                                }),
                                (0, F.jsx)(`pre`, {
                                    className: `text-[11px] text-scientific-slate/70 whitespace-pre-wrap break-all`,
                                    children: this.state.error.toString()
                                })
                            ]
                        }),
                        (0, F.jsxs)(`div`, {
                            className: `flex space-x-6 w-full pt-6`,
                            children: [
                                (0, F.jsxs)(`button`, {
                                    onClick: ()=>window.location.reload(),
                                    className: `flex-1 bg-scientific-royal text-white py-5 rounded-2xl text-[12px] font-black uppercase tracking-[0.4em] shadow-xl shadow-blue-100 hover:bg-black transition-all flex items-center justify-center space-x-4`,
                                    children: [
                                        (0, F.jsx)(gr, {
                                            size: 18
                                        }),
                                ...
                                (0, F.jsx)(`button`, {
                                    ...
                                    className: `px-10 border-2 border-scientific-sage text-scientific-slate/40 py-5 rounded-2xl text-[12px] font-black uppercase tracking-[0.4em] hover:border-scientific-royal hover:text-scientific-royal transition-all`,
                                    children: (0, F.jsx)(dr, {
                                        size: 18
                                    })
                                })
    ...
    console.log(`Main: Initializing React tree...`), (0, v.createRoot)(document.getElementById(`root`)).render((0, F.jsx)(_.StrictMode, {
        children: (0, F.jsx)(mi, {
            children: (0, F.jsx)(pi, {})
        })
    }));
