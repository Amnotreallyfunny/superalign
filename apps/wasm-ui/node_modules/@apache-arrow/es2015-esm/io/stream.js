...
import { ITERATOR_DONE, AsyncQueue } from './interfaces.js';
import { toUint8Array, joinUint8Arrays } from '../util/buffer.js';
import { isPromise, isFetchResponse, isIterable, isAsyncIterable, isReadableDOMStream, isReadableNodeStream } from '../util/compat.js';
/** @ignore */
