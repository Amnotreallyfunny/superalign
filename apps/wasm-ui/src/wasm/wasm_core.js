...
export class WasmParser {
    ...
    /**
     * @param {string} pipeline_version
     */
    constructor(pipeline_version) {
        const ptr0 = passStringToWasm0(pipeline_version, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    parse_chunk(chunk) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmparser_parse_chunk(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
